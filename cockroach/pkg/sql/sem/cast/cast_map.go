...
var castMap = map[oid.Oid]map[oid.Oid]Cast{
	...
	oid.T_bpchar: {
		...
		oidext.T_ltree:     {MaxContext: ContextExplicit, origin: ContextOriginAutomaticIOConversion, Volatility: volatility.Immutable},
	...
	oid.T_bytea: {
		...
		oidext.T_citext: {MaxContext: ContextAssignment, origin: ContextOriginAutomaticIOConversion, Volatility: volatility.Stable},
	},
	oidext.T_citext: {
		oid.T_bpchar:  {MaxContext: ContextAssignment, origin: ContextOriginPgCast, Volatility: volatility.Immutable},
		oid.T_text:    {MaxContext: ContextImplicit, origin: ContextOriginPgCast, Volatility: volatility.Immutable},
		...
		oid.T_date: {
			...
			origin:         ContextOriginAutomaticIOConversion,
			Volatility:     volatility.Stable,
			VolatilityHint: `CITEXT to DATE casts depend on session DateStyle; consider using to_char(citext) instead`,
		},
		oid.T_float4:       {MaxContext: ContextExplicit, origin: ContextOriginAutomaticIOConversion, Volatility: volatility.Immutable},
		oid.T_float8:       {MaxContext: ContextExplicit, origin: ContextOriginAutomaticIOConversion, Volatility: volatility.Immutable},
		oidext.T_geography: {MaxContext: ContextExplicit, origin: ContextOriginAutomaticIOConversion, Volatility: volatility.Immutable},
		...
		oid.T_interval: {
			...
			origin:         ContextOriginAutomaticIOConversion,
			Volatility:     volatility.Stable,
			VolatilityHint: `CITEXT to INTERVAL casts depend on session IntervalStyle; consider using to_char(citext) instead`,
		},
		oid.T_jsonb:        {MaxContext: ContextExplicit, origin: ContextOriginAutomaticIOConversion, Volatility: volatility.Immutable},
		oidext.T_jsonpath:  {MaxContext: ContextExplicit, origin: ContextOriginAutomaticIOConversion, Volatility: volatility.Immutable},
		oidext.T_ltree:     {MaxContext: ContextExplicit, origin: ContextOriginAutomaticIOConversion, Volatility: volatility.Immutable},
		...
		oid.T_time: {
			...
			origin:         ContextOriginAutomaticIOConversion,
			Volatility:     volatility.Stable,
			VolatilityHint: `CITEXT to TIME casts depend on session DateStyle; consider using to_char(citext) instead`,
		},
		oid.T_timestamp: {
			MaxContext: ContextExplicit,
			origin:     ContextOriginAutomaticIOConversion,
			Volatility: volatility.Stable,
			VolatilityHint: `CITEXT to TIMESTAMP casts are context-dependent because of relative timestamp strings ` +
				"like 'now' and session settings such as DateStyle; consider using to_char(citext) instead.",
		},
		oid.T_timestamptz: {
			MaxContext: ContextExplicit,
			origin:     ContextOriginAutomaticIOConversion,
		...
		oid.T_timetz: {
			...
			origin:         ContextOriginAutomaticIOConversion,
			Volatility:     volatility.Stable,
			VolatilityHint: `CITEXT to TIMETZ casts depend on session DateStyle; consider using to_char(citext) instead`,
		},
		oid.T_tsquery:     {MaxContext: ContextExplicit, origin: ContextOriginAutomaticIOConversion, Volatility: volatility.Immutable},
		oid.T_tsvector:    {MaxContext: ContextExplicit, origin: ContextOriginAutomaticIOConversion, Volatility: volatility.Immutable},
		oid.T_uuid:        {MaxContext: ContextExplicit, origin: ContextOriginAutomaticIOConversion, Volatility: volatility.Immutable},
		oidext.T_pgvector: {MaxContext: ContextExplicit, origin: ContextOriginAutomaticIOConversion, Volatility: volatility.Immutable},
		oid.T_varbit:      {MaxContext: ContextExplicit, origin: ContextOriginAutomaticIOConversion, Volatility: volatility.Immutable},
		oid.T_void:        {MaxContext: ContextExplicit, origin: ContextOriginAutomaticIOConversion, Volatility: volatility.Stable},
	},
	oid.T_char: {
		oid.T_bpchar:  {MaxContext: ContextAssignment, origin: ContextOriginPgCast, Volatility: volatility.Immutable},
		oid.T_int4:    {MaxContext: ContextExplicit, origin: ContextOriginPgCast, Volatility: volatility.Immutable},
	...
	oid.T_date: {
		...
		oidext.T_citext: {
			...
			origin:     ContextOriginAutomaticIOConversion,
			Volatility: volatility.Stable,
			VolatilityHint: "DATE to CITEXT casts are dependent on DateStyle; consider " +
				"using to_char(date) instead.",
		},
	},
	oid.T_float4: {
	...
	oid.T_interval: {
		...
		oidext.T_citext: {
			...
			origin:         ContextOriginAutomaticIOConversion,
			Volatility:     volatility.Stable,
			VolatilityHint: "INTERVAL to CITEXT casts depend on IntervalStyle; consider using to_char(interval)",
		},
	},
	oid.T_jsonb: {
		oid.T_bool:         {MaxContext: ContextExplicit, origin: ContextOriginPgCast, Volatility: volatility.Immutable},
	...
	oid.T_timestamp: {
		...
		oidext.T_citext: {
			...
			origin:     ContextOriginAutomaticIOConversion,
			Volatility: volatility.Stable,
			VolatilityHint: "TIMESTAMP to CITEXT casts are dependent on DateStyle; consider " +
				"using to_char(timestamp) instead.",
		},
	},
	oid.T_timestamptz: {
		...
		oidext.T_citext: {
			...
			origin:     ContextOriginAutomaticIOConversion,
			Volatility: volatility.Stable,
			VolatilityHint: "TIMESTAMPTZ to CITEXT casts depend on the current timezone; consider " +
				"using to_char(t AT TIME ZONE 'UTC') instead.",
		},
	},
	oid.T_timetz: {
