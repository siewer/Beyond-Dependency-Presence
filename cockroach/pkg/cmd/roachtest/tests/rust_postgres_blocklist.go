...
var rustPostgresBlocklist = blocklist{
	"copy_in":                                "COPY FROM not supported in extended protocol mode",
	"copy_in_error":                          "COPY FROM not supported in extended protocol mode",
	"copy_in_large":                          "COPY FROM not supported in extended protocol mode",
	"custom_array":                           "unsupported datatype - https://github.com/cockroachdb/cockroach/issues/41284",
	"custom_composite":                       "unsupported feature - https://github.com/cockroachdb/cockroach/issues/27792",
	"custom_domain":                          "unsupported feature - https://github.com/cockroachdb/cockroach/issues/27796",
	"custom_enum":                            "experimental feature - https://github.com/cockroachdb/cockroach/issues/46260",
	"custom_range":                           "unsupported feature - https://github.com/cockroachdb/cockroach/issues/27791",
	"deferred_constraint":                    "unsupported feature - https://github.com/cockroachdb/cockroach/issues/31632",
	"insert_select":                          "default int size (int4 vs int8) mismatch",
	"md5_password_ok":                        "password authentication failed",
	"notices":                                "notice count mismatch",
	"notifications":                          "unsupported feature - https://github.com/cockroachdb/cockroach/issues/41522",
	"pipelined_prepare":                      "unsupported datatype - https://github.com/cockroachdb/cockroach/issues/41284",
	"plain_password_ok":                      "password authentication failed",
	"query_portal":                           "default int size (int4 vs int8) mismatch",
	"scram_password_ok":                      "password authentication failed",
	"transaction_builder":                    "cannot execute INSERT in a read-only transaction",
	"transaction_commit_future_cancellation": "unknown function: txid_current()",
	"transaction_future_cancellation":        "unknown function: txid_current()",
	"transaction_rollback_future_cancellation": "unknown function: txid_current()",
