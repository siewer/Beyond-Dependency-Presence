...
var activeRecordIgnoreList = blocklist{
	...
	`ActiveRecord::LoadAsyncTest#test_load_async_has_many_through_association`:                                                                                 "flaky",
	`ActiveRecord::LoadAsyncTest#test_notification_forwarding`:                                                                                                 "flaky",
	`ActiveRecord::LoadAsyncTest#test_simple_query`:                                                                                                            "flaky",
