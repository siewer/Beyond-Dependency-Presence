...
// getSHA retrieves the current Git commit SHA and working directory path.
// It returns the Git SHA hash of the current HEAD commit and the absolute path
// to the CockroachDB working directory (verified by presence of WORKSPACE file).
