...
// Metrics is from github.com/hashicorp/vault/helper/metricsutil, which isn't ready
...
func NewJobManager(name string, numWorkers int, l log.Logger, metricSink Metrics) *JobManager {
	if l == nil {
