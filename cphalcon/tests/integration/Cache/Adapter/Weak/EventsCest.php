...
class EventsCest
{
     ...
     * @since  2024-06-07
     */
    public function cacheAdapterWeakGetEventsManagerNotSet(IntegrationTester $I): void
    {
        $I->wantToTest('Cache\Adapter\Weak() - getEventsManager() - not set');
     ...
     * @since  2024-06-07
     */
    public function cacheAdapterWeakGetEventsManagerSet(IntegrationTester $I): void
    {
        $I->wantToTest('Cache\Adapter\Weak() - getEventsManager() - set');
    ...
    /**
     * Tests Cache\Adapter\Weak() :: trigger cache events
     *
