...
PHP_METHOD(Phalcon_Image_Adapter_Gd, processBackground)
{
	...
	ZVAL_LONG(&_8, 0);
	ZVAL_LONG(&_9, 0);
	ZEPHIR_CALL_FUNCTION(&copy, "imagecopy", NULL, 379, &background, &image, &_6, &_7, &_8, &_9, &_4, &_5);
	zephir_check_call_status();
...
PHP_METHOD(Phalcon_Image_Adapter_Gd, processRotate)
{
	...
	ZVAL_LONG(&_6, 0);
	ZVAL_LONG(&_7, 100);
	ZEPHIR_CALL_FUNCTION(&copy, "imagecopymerge", NULL, 402, &_2, &image, &_3, &_4, &_5, &_6, &width, &height, &_7);
	zephir_check_call_status();
	if (!ZEPHIR_IS_FALSE_IDENTICAL(&copy)) {
...
PHP_METHOD(Phalcon_Image_Adapter_Gd, processWatermark)
{
	...
	ZEPHIR_CALL_FUNCTION(&copy, "imagecopy", NULL, 379, &_10, &overlay, &_11, &_12, &_13, &_14, &_15, &_16);
	zephir_check_call_status();
