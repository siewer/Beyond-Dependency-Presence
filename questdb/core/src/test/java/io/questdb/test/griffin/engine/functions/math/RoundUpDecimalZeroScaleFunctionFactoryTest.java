...
import io.questdb.griffin.engine.functions.math.RoundUpDecimalZeroScaleFunctionFactory;
 ...
 */
public class RoundUpDecimalZeroScaleFunctionFactoryTest extends AbstractCairoTest {
    private final ObjList<Function> args = new ObjList<>();
    private final RoundUpDecimalZeroScaleFunctionFactory factory = new RoundUpDecimalZeroScaleFunctionFactory();
    ...
    @Test
    public void testRoundUpPositive() {
        args.clear();
