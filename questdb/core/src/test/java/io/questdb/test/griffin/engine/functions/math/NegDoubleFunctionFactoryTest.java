...
public class NegDoubleFunctionFactoryTest extends AbstractFunctionFactoryTest {
    ...
    public void testNegative() throws SqlException {
        call(-123.55).andAssert(123.55, 0.0000000001);
    }
    ...
    protected FunctionFactory getFunctionFactory() {
        return new NegDoubleFunctionFactory();
    }
}