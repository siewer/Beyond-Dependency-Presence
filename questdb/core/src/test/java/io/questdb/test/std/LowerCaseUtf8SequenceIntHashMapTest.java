...
public class LowerCaseUtf8SequenceIntHashMapTest {
    ...
    public void testHashMapCompatibility() {
        ...
        LowerCaseUtf8SequenceIntHashMap ourMap = new LowerCaseUtf8SequenceIntHashMap();
        try {
    ...
    public void testHashMapUtf8() {
        ...
        long mem = Unsafe.malloc(memSize, MemoryTag.NATIVE_DEFAULT);
        final DirectUtf8String dus = new DirectUtf8String();
        LowerCaseUtf8SequenceIntHashMap map = new LowerCaseUtf8SequenceIntHashMap();
        try {
