...
import io.questdb.griffin.engine.functions.math.CeilingDecimalZeroScaleFunctionFactory;
 ...
 */
public class CeilingDecimalZeroScaleFunctionFactoryTest extends AbstractCairoTest {
    private final ObjList<Function> args = new ObjList<>();
    private final CeilingDecimalZeroScaleFunctionFactory factory = new CeilingDecimalZeroScaleFunctionFactory();
