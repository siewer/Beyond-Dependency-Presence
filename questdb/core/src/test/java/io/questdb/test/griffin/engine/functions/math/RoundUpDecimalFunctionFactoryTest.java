...
import io.questdb.griffin.engine.functions.math.RoundUpDecimalFunctionFactory;
 ...
 */
public class RoundUpDecimalFunctionFactoryTest extends AbstractCairoTest {
    private final ObjList<Function> args = new ObjList<>();
    private final RoundUpDecimalFunctionFactory factory = new RoundUpDecimalFunctionFactory();
