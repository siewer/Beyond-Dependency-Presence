...
import io.questdb.griffin.engine.functions.math.FloorDecimalFunctionFactory;
 ...
 */
public class FloorDecimalFunctionFactoryTest extends AbstractCairoTest {
    private final ObjList<Function> args = new ObjList<>();
    private final FloorDecimalFunctionFactory factory = new FloorDecimalFunctionFactory();
