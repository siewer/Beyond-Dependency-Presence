...
import io.questdb.griffin.engine.functions.math.CeilingDecimalFunctionFactory;
 ...
 */
public class CeilingDecimalFunctionFactoryTest extends AbstractCairoTest {
    private final ObjList<Function> args = new ObjList<>();
    private final CeilingDecimalFunctionFactory factory = new CeilingDecimalFunctionFactory();
