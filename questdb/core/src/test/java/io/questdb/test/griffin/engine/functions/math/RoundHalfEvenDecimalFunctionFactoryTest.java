...
import io.questdb.griffin.engine.functions.math.RoundHalfEvenDecimalFunctionFactory;
 ...
 */
public class RoundHalfEvenDecimalFunctionFactoryTest extends AbstractCairoTest {
    private final ObjList<Function> args = new ObjList<>();
    private final RoundHalfEvenDecimalFunctionFactory factory = new RoundHalfEvenDecimalFunctionFactory();
    ...
    public void testRoundHalfEvenNegative() {
        ...
        try (Function func = factory.newInstance(-1, args, null, configuration, sqlExecutionContext)) {
            ...
            Assert.assertEquals(ColumnType.getDecimalType(4, 1), func.getType());
        }
    }
