...
public class AtanDoubleFunctionFactoryTest extends AbstractFunctionFactoryTest {
    ...
    public void testNegative() throws SqlException {
        call(-1.0).andAssert(-Math.PI / 4, DELTA);
    }
    ...
    public void testZero() throws SqlException {
        ...
        call(-0.0000000000000001).andAssert(-0.0, DELTA);
    }

    @Override
    protected FunctionFactory getFunctionFactory() {
        return new AtanDoubleFunctionFactory();
    }
}
