...
public class ToNanoTimestampVCFunctionFactoryTest extends AbstractFunctionFactoryTest {
    ...
    public void testNullPattern() {
        assertFailure(19, "pattern is required", "2015", null);
    }

    @Test
    public void testSimple() throws SqlException {
        call("2015 03/12 514", "yyyy dd/MM UUU").andAssertTimestamp(1449100800000514000L);
    }
    ...
    public void test_whenInputStringIsConstant_functionReturnsConstant() throws SqlException {
        ...
        Function f = new ToNanoTimestampVCFunctionFactory().newInstance(0, funcs, new IntList(), configuration, sqlExecutionContext);
    ...
    public void test_whenInputStringIsNotConstant_functionDoesntCacheValue() throws SqlException {
        ObjList<Function> funcs = new ObjList<>();
        funcs.add(TimestampColumn.newInstance(1, ColumnType.TIMESTAMP_NANO));
        funcs.add(new StrConstant("yyyy dd/MM"));
    ...
    protected FunctionFactory getFunctionFactory() {
        return new ToNanoTimestampVCFunctionFactory();
    }
}
