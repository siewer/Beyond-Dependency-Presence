...
import io.questdb.griffin.engine.functions.math.FloorDecimalZeroScaleFunctionFactory;
 ...
 */
public class FloorDecimalZeroScaleFunctionFactoryTest extends AbstractCairoTest {
    private final ObjList<Function> args = new ObjList<>();
    private final FloorDecimalZeroScaleFunctionFactory factory = new FloorDecimalZeroScaleFunctionFactory();
