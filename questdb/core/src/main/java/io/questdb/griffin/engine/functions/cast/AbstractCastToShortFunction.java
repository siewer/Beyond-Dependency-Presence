...
/**
 * Abstract base class for functions that cast values to short.
 */
public abstract class AbstractCastToShortFunction extends ShortFunction implements CastFunction {
    /**
