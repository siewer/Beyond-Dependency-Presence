...
public class IntPlusIPv4FunctionFactory implements FunctionFactory {
    ...
    public static final class IntPlusIPv4Function extends IPv4Function implements ArithmeticBinaryFunction {
        private final Function left;
        private final Function right;

        public IntPlusIPv4Function(Function left, Function right) {
            this.left = left;
            this.right = right;
        }
