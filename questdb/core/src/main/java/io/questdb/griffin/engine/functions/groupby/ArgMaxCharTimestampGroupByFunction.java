...
public class ArgMaxCharTimestampGroupByFunction extends CharFunction implements GroupByFunction, BinaryFunction {
    private final Function keyArg;
    private final Function valueArg;
    private int valueIndex;

    public ArgMaxCharTimestampGroupByFunction(@NotNull Function valueArg, @NotNull Function keyArg) {
