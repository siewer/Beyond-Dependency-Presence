...
public class BitOrByteGroupByFunction extends ByteFunction implements GroupByFunction, UnaryFunction {
    private final Function arg;
    private int valueIndex;

    public BitOrByteGroupByFunction(@NotNull Function arg) {
        this.arg = arg;
    }
