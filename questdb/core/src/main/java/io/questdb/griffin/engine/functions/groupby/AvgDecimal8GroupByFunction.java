...
class AvgDecimal8GroupByFunction extends Decimal8Function implements GroupByFunction, UnaryFunction {
    private final Function arg;
    private final Decimal64 decimal64A = new Decimal64();
    private final int position;
    private int valueIndex;

    public AvgDecimal8GroupByFunction(@NotNull Function arg, int position) {
        super(arg.getType());
        this.arg = arg;
    ...
    public byte getDecimal8(Record rec) {
        ...
        if (count > 0) {
            ...
            return (byte) decimal64A.getValue();
        } else {
