...
public class ArgMinCharLongGroupByFunction extends CharFunction implements GroupByFunction, BinaryFunction {
    private final Function keyArg;
    private final Function valueArg;
    private int valueIndex;

    public ArgMinCharLongGroupByFunction(@NotNull Function valueArg, @NotNull Function keyArg) {
