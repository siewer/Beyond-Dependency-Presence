...
public class BitOrShortGroupByFunction extends ShortFunction implements GroupByFunction, UnaryFunction {
    private final Function arg;
    private int valueIndex;

    public BitOrShortGroupByFunction(@NotNull Function arg) {
        this.arg = arg;
    }
