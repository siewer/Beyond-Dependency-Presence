...
public class BitXorIntGroupByFunction extends IntFunction implements GroupByFunction, UnaryFunction {
    private final Function arg;
    private int valueIndex;

    public BitXorIntGroupByFunction(@NotNull Function arg) {
        this.arg = arg;
    }
