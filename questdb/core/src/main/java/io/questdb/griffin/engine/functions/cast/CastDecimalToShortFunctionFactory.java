...
public class CastDecimalToShortFunctionFactory implements FunctionFactory {
    ...
    private static boolean overflowsShort(Decimal256 decimal256) {
        return decimal256.getHh() >= 0 ? Decimal256.compare(decimal256, 0, 0, 0, Short.MAX_VALUE) > 0 :
                Decimal256.compare(decimal256, -1, -1, -1, Short.MIN_VALUE) < 0;
    }

    private static boolean overflowsShort(Decimal128 decimal128) {
        return decimal128.getHigh() >= 0 ? Decimal128.compare(decimal128, 0, Short.MAX_VALUE) > 0 :
                Decimal128.compare(decimal128, -1, Short.MIN_VALUE) < 0;
    }

    private static class ScaledDecimal128Function extends AbstractCastToShortFunction {
    ...
    private static class ScaledDecimal16Function extends AbstractCastToShortFunction {
        private final Decimal256 decimal256 = new Decimal256();
        private final int fromScale;
        private final int position;
    ...
    private static class ScaledDecimal256Function extends AbstractCastToShortFunction {
        private final Decimal256 decimal256 = new Decimal256();
        private final int fromScale;
        private final int position;
    ...
    private static class ScaledDecimal32Function extends AbstractCastToShortFunction {
        private final Decimal256 decimal256 = new Decimal256();
        private final int fromScale;
        private final int position;
    ...
    private static class ScaledDecimal64Function extends AbstractCastToShortFunction {
        private final Decimal256 decimal256 = new Decimal256();
        private final int fromScale;
        private final int position;
    ...
    private static class ScaledDecimal8Function extends AbstractCastToShortFunction {
        private final Decimal256 decimal256 = new Decimal256();
        private final int fromScale;
        private final int position;
    ...
    private static class UnscaledDecimal128Func extends AbstractCastToShortFunction {
        ...
        public short getShort(Record rec) {
            ...
            if (overflowsShort(decimal128)) {
                throw ImplicitCastException.inconvertibleValue(decimal128, arg.getType(), ColumnType.SHORT).position(position);
            }
