 ...
 */
final class FastFloatMem {

    private static float dealWithNaN(float value, long str, int startIndex, int endIndex, boolean rejectOverflow) throws NumericException {
    ...
    static float valueOfFloatLiteral(
        ...
        return dealWithNaN(f, str, startIndex, endIndex, rejectOverflow);
    }
