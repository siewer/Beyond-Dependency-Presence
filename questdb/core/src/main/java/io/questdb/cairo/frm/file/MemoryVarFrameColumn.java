...
public class MemoryVarFrameColumn implements FrameColumn {
    ...
    public long getContiguousAuxAddr(long rowHi) {
        ...
        return columnMemoryAux.addressOf(0);
    }
    ...
    public long getContiguousDataAddr(long rowHi) {
        ...
        return columnMemoryData.addressOf(0);
    }
    ...
    public void of(
            ...
            int columnType,
            long rowCount,
            MemoryCR columnMemoryData,
            MemoryCR columnMemoryAux
    ) {
        this.rowCount = rowCount;
        this.columnMemoryData = columnMemoryData;
        this.columnMemoryAux = columnMemoryAux;
