...
public enum PropertyKey implements ConfigPropertyKey {
    ...
    CAIRO_PARQUET_EXPORT_BLOOM_FILTER_FPP("cairo.parquet.export.bloom.filter.fpp"),
    ...
    CAIRO_VIEW_WAL_INACTIVE_WRITER_TTL("cairo.view.wal.inactive.writer.ttl"),
    ...
    VIEW_COMPILER_WORKER_SLEEP_TIMEOUT("view.compiler.worker.sleep.timeout"),
