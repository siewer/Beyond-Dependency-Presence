...
public class Decimal128ModuloBenchmark {
    ...
    @Param({"SIMPLE", "LARGE_NUMBERS", "SMALL_NUMBERS", "DIFFERENT_SCALES", "NEAR_DIVISOR", "FRACTIONAL", "MIXED_128_64", "PURE_64_BIT"})
    private String scenario;

    public static void main(String[] args) throws RunnerException {
        Options opt = new OptionsBuilder()
                .include(Decimal128ModuloBenchmark.class.getSimpleName())
                .warmupIterations(5)
    ...
    @Benchmark
    public Decimal128 decimal128Modulo() {
        decimal128Result.copyFrom(decimal128Dividend);
        decimal128Result.modulo(decimal128Divisor);
    ...
    public void setup() {
        ...
        switch (scenario) {
            case "SIMPLE":
                ...
                decimal128Dividend = Decimal128.fromDouble(789.123, 3);
                decimal128Divisor = Decimal128.fromDouble(12.34, 2);
            ...
            case "LARGE_NUMBERS":
                ...
                decimal128Dividend = Decimal128.fromDouble(987654321.123, 3);
                decimal128Divisor = Decimal128.fromDouble(123456.789, 3);
            ...
            case "SMALL_NUMBERS":
                ...
                decimal128Dividend = Decimal128.fromDouble(0.00789, 5);
                decimal128Divisor = Decimal128.fromDouble(0.00123, 5);
            ...
            case "DIFFERENT_SCALES":
                ...
                decimal128Divisor = Decimal128.fromDouble(7.8901234, 7);
            ...
            case "NEAR_DIVISOR":
                ...
                decimal128Dividend = Decimal128.fromDouble(123.456, 3);
                decimal128Divisor = Decimal128.fromDouble(123.123, 3);
                bigDecimalDividend = new BigDecimal("123.456");
            ...
            case "FRACTIONAL":
                ...
                decimal128Dividend = Decimal128.fromDouble(3.14159, 5);
                decimal128Divisor = Decimal128.fromDouble(2.71828, 5);
            ...
            case "PURE_64_BIT":
                // Modulo of two 64-bit values within Decimal128
                decimal128Dividend = Decimal128.fromDouble(987654.321, 3);
