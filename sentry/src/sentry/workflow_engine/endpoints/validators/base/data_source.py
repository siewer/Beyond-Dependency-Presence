...
class BaseDataSourceValidator(CamelSnakeModelSerializer[T], Generic[T]):
    @property
    def data_source_type_handler(self) -> type[DataSourceTypeHandler[Any]]:
    ...
    def validated_create_source(self, validated_data: dict[str, Any]) -> T:
        """
    ...
    def create_source(self, validated_data: dict[str, Any]) -> T:
        """
