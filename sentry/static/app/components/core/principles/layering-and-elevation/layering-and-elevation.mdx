...
import backgroundElevationColors from './__stories__/background-elevation-colors.png';
import chonkyBordersPerspective from './__stories__/chonky-borders-perspective.png';
import floatingElementsShadows from './__stories__/floating-elements-shadows.png';
import objectModelDiagram from './__stories__/object-model-diagram.png';
