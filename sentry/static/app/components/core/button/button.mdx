...
export const documentation = import('!!type-loader!@sentry/scraps/button').then(
  module => {
    const buttonDocumentation = module.default;
    return {
      exports: {
...
| <IconCopy />                               | `copy`      | Copy                                   | Copy data to clipboard                                    |
| <IconDownload />                           | `download`  | Download                               | Download data as a file                                   |
