...
export const controlsiloUrlPatterns: RegExp[] = [
  ...
  new RegExp('^remote/vercel/v1/installations/[^/]+/resources/[^/]+/plans/$'),
  new RegExp('^remote/vercel/v1/products/[^/]+/plans/$'),
  new RegExp('^remote/vercel/v1/installations/[^/]+/$'),
  new RegExp('^remote/vercel/v1/installations/[^/]+/resources$'),
  new RegExp('^remote/vercel/v1/installations/[^/]+/resources/[^/]+$'),
  ...
  new RegExp('^api/0/billing-plans/$'),
  ...
  new RegExp('^api/0/sentry-apps/[^/]+/interaction/$'),
  new RegExp('^api/0/sentry-app-installations/[^/]+/$'),
  new RegExp('^api/0/sentry-app-installations/[^/]+/authorizations/$'),
  new RegExp('^api/0/sentry-app-installations/[^/]+/external-requests/$'),
  new RegExp('^api/0/sentry-app-installations/[^/]+/external-issue-actions/$'),
  ...
  new RegExp('^api/0/auth-v2/user-merge-verification-codes/$'),
  new RegExp('^api/0/auth-v2/merge-accounts/$'),
  new RegExp('^api/0/broadcasts/$'),
  new RegExp('^api/0/broadcasts/[^/]+/$'),
