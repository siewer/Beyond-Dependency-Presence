...
return [
    ...
    'notifications' => [
        ...
        'max_rows' => [
            ...
            'body' => 'Ви не можете імпортувати більше :count рядка одночасно.|Ви не можете імпортувати більше :count рядків одночасно.|Ви не можете імпортувати більше :count рядків одночасно.',
        ],

        'started' => [
            'title' => 'Імпорт розпочався',
            'body' => 'Ваш імпорт розпочався, і :count рядок буде опрацьовано у фоновому режимі.|Ваш імпорт розпочався, і :count рядки буде опрацьовано у фоновому режимі.|Ваш імпорт розпочався, і :count рядків буде опрацьовано у фоновому режимі.',
        ],
