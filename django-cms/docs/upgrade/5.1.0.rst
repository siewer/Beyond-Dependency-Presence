...
See the How to upgrade to 5.1.0a1 to a newer version guide if you’re
...
* Async support: User middleware and apphook registration support async setups
  and now let you run django CMS using asgi. Database access is avoided when
  registering apphook URLs to make them async-safe.
