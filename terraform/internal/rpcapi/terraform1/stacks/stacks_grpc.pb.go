...
type StacksClient interface {
	...
	OpenState(ctx context.Context, opts ...grpc.CallOption) (grpc.ClientStreamingClient[OpenStackState_RequestItem, OpenStackState_Response], error)
	...
	PlanStackChanges(ctx context.Context, in *PlanStackChanges_Request, opts ...grpc.CallOption) (grpc.ServerStreamingClient[PlanStackChanges_Event], error)
	...
	OpenPlan(ctx context.Context, opts ...grpc.CallOption) (grpc.ClientStreamingClient[OpenStackPlan_RequestItem, OpenStackPlan_Response], error)
	...
	ApplyStackChanges(ctx context.Context, in *ApplyStackChanges_Request, opts ...grpc.CallOption) (grpc.ServerStreamingClient[ApplyStackChanges_Event], error)
	...
	MigrateTerraformState(ctx context.Context, in *MigrateTerraformState_Request, opts ...grpc.CallOption) (grpc.ServerStreamingClient[MigrateTerraformState_Event], error)
...
func (c *stacksClient) OpenStackConfiguration(ctx context.Context, in *OpenStackConfiguration_Request, opts ...grpc.CallOption) (*OpenStackConfiguration_Response, error) {
	...
	err := c.cc.Invoke(ctx, Stacks_OpenStackConfiguration_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *stacksClient) CloseStackConfiguration(ctx context.Context, in *CloseStackConfiguration_Request, opts ...grpc.CallOption) (*CloseStackConfiguration_Response, error) {
	...
	err := c.cc.Invoke(ctx, Stacks_CloseStackConfiguration_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *stacksClient) ValidateStackConfiguration(ctx context.Context, in *ValidateStackConfiguration_Request, opts ...grpc.CallOption) (*ValidateStackConfiguration_Response, error) {
	...
	err := c.cc.Invoke(ctx, Stacks_ValidateStackConfiguration_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *stacksClient) FindStackConfigurationComponents(ctx context.Context, in *FindStackConfigurationComponents_Request, opts ...grpc.CallOption) (*FindStackConfigurationComponents_Response, error) {
	...
	err := c.cc.Invoke(ctx, Stacks_FindStackConfigurationComponents_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *stacksClient) OpenState(ctx context.Context, opts ...grpc.CallOption) (grpc.ClientStreamingClient[OpenStackState_RequestItem, OpenStackState_Response], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &Stacks_ServiceDesc.Streams[0], Stacks_OpenState_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &grpc.GenericClientStream[OpenStackState_RequestItem, OpenStackState_Response]{ClientStream: stream}
	return x, nil
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type Stacks_OpenStateClient = grpc.ClientStreamingClient[OpenStackState_RequestItem, OpenStackState_Response]
...
func (c *stacksClient) CloseState(ctx context.Context, in *CloseStackState_Request, opts ...grpc.CallOption) (*CloseStackState_Response, error) {
	...
	err := c.cc.Invoke(ctx, Stacks_CloseState_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *stacksClient) PlanStackChanges(ctx context.Context, in *PlanStackChanges_Request, opts ...grpc.CallOption) (grpc.ServerStreamingClient[PlanStackChanges_Event], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &Stacks_ServiceDesc.Streams[1], Stacks_PlanStackChanges_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &grpc.GenericClientStream[PlanStackChanges_Request, PlanStackChanges_Event]{ClientStream: stream}
...
// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type Stacks_PlanStackChangesClient = grpc.ServerStreamingClient[PlanStackChanges_Event]

func (c *stacksClient) OpenPlan(ctx context.Context, opts ...grpc.CallOption) (grpc.ClientStreamingClient[OpenStackPlan_RequestItem, OpenStackPlan_Response], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &Stacks_ServiceDesc.Streams[2], Stacks_OpenPlan_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &grpc.GenericClientStream[OpenStackPlan_RequestItem, OpenStackPlan_Response]{ClientStream: stream}
	return x, nil
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type Stacks_OpenPlanClient = grpc.ClientStreamingClient[OpenStackPlan_RequestItem, OpenStackPlan_Response]
...
func (c *stacksClient) ClosePlan(ctx context.Context, in *CloseStackPlan_Request, opts ...grpc.CallOption) (*CloseStackPlan_Response, error) {
	...
	err := c.cc.Invoke(ctx, Stacks_ClosePlan_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *stacksClient) ApplyStackChanges(ctx context.Context, in *ApplyStackChanges_Request, opts ...grpc.CallOption) (grpc.ServerStreamingClient[ApplyStackChanges_Event], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &Stacks_ServiceDesc.Streams[3], Stacks_ApplyStackChanges_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &grpc.GenericClientStream[ApplyStackChanges_Request, ApplyStackChanges_Event]{ClientStream: stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type Stacks_ApplyStackChangesClient = grpc.ServerStreamingClient[ApplyStackChanges_Event]
...
func (c *stacksClient) OpenStackInspector(ctx context.Context, in *OpenStackInspector_Request, opts ...grpc.CallOption) (*OpenStackInspector_Response, error) {
	...
	err := c.cc.Invoke(ctx, Stacks_OpenStackInspector_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *stacksClient) InspectExpressionResult(ctx context.Context, in *InspectExpressionResult_Request, opts ...grpc.CallOption) (*InspectExpressionResult_Response, error) {
	...
	err := c.cc.Invoke(ctx, Stacks_InspectExpressionResult_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *stacksClient) OpenTerraformState(ctx context.Context, in *OpenTerraformState_Request, opts ...grpc.CallOption) (*OpenTerraformState_Response, error) {
	...
	err := c.cc.Invoke(ctx, Stacks_OpenTerraformState_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *stacksClient) CloseTerraformState(ctx context.Context, in *CloseTerraformState_Request, opts ...grpc.CallOption) (*CloseTerraformState_Response, error) {
	...
	err := c.cc.Invoke(ctx, Stacks_CloseTerraformState_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *stacksClient) MigrateTerraformState(ctx context.Context, in *MigrateTerraformState_Request, opts ...grpc.CallOption) (grpc.ServerStreamingClient[MigrateTerraformState_Event], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &Stacks_ServiceDesc.Streams[4], Stacks_MigrateTerraformState_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &grpc.GenericClientStream[MigrateTerraformState_Request, MigrateTerraformState_Event]{ClientStream: stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type Stacks_MigrateTerraformStateClient = grpc.ServerStreamingClient[MigrateTerraformState_Event]
...
func (c *stacksClient) ListResourceIdentities(ctx context.Context, in *ListResourceIdentities_Request, opts ...grpc.CallOption) (*ListResourceIdentities_Response, error) {
	...
	err := c.cc.Invoke(ctx, Stacks_ListResourceIdentities_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type StacksServer interface {
	...
	// Load a stack state by sending a stream of raw state objects that were
	// streamed from a previous ApplyStackChanges response.
	OpenState(grpc.ClientStreamingServer[OpenStackState_RequestItem, OpenStackState_Response]) error
	// Close a stack state handle, discarding the associated state.
	CloseState(context.Context, *CloseStackState_Request) (*CloseStackState_Response, error)
	// Calculate a desired state from the given configuration and compare it
	// with the current state to propose a set of changes to converge the
	// current state with the desired state, at least in part.
	PlanStackChanges(*PlanStackChanges_Request, grpc.ServerStreamingServer[PlanStackChanges_Event]) error
	// Load a previously-created plan by sending a stream of raw change objects
	// that were streamed from a previous PlanStackChanges response.
	OpenPlan(grpc.ClientStreamingServer[OpenStackPlan_RequestItem, OpenStackPlan_Response]) error
	// Close a saved plan handle, discarding the associated saved plan.
	ClosePlan(context.Context, *CloseStackPlan_Request) (*CloseStackPlan_Response, error)
	// Execute the changes proposed by an earlier call to PlanStackChanges.
	ApplyStackChanges(*ApplyStackChanges_Request, grpc.ServerStreamingServer[ApplyStackChanges_Event]) error
	// OpenStackInspector creates a stack inspector handle that can be used
	// with subsequent calls to the "Inspect"-prefixed functions.
	...
	// MigrateTerraformState migrates a Terraform state into Stacks state using
	// a mapping of addresses.
	MigrateTerraformState(*MigrateTerraformState_Request, grpc.ServerStreamingServer[MigrateTerraformState_Event]) error
	// ListResourceIdentities lists the identities of all resources in a stack.
...
// UnimplementedStacksServer must be embedded to have
...
func (UnimplementedStacksServer) OpenState(grpc.ClientStreamingServer[OpenStackState_RequestItem, OpenStackState_Response]) error {
...
func (UnimplementedStacksServer) PlanStackChanges(*PlanStackChanges_Request, grpc.ServerStreamingServer[PlanStackChanges_Event]) error {
	return status.Errorf(codes.Unimplemented, "method PlanStackChanges not implemented")
}
func (UnimplementedStacksServer) OpenPlan(grpc.ClientStreamingServer[OpenStackPlan_RequestItem, OpenStackPlan_Response]) error {
...
func (UnimplementedStacksServer) ApplyStackChanges(*ApplyStackChanges_Request, grpc.ServerStreamingServer[ApplyStackChanges_Event]) error {
...
func (UnimplementedStacksServer) MigrateTerraformState(*MigrateTerraformState_Request, grpc.ServerStreamingServer[MigrateTerraformState_Event]) error {
...
func (UnimplementedStacksServer) testEmbeddedByValue()                {}
...
func RegisterStacksServer(s grpc.ServiceRegistrar, srv StacksServer) {
	// If the following call pancis, it indicates UnimplementedStacksServer was
...
func _Stacks_OpenState_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(StacksServer).OpenState(&grpc.GenericServerStream[OpenStackState_RequestItem, OpenStackState_Response]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type Stacks_OpenStateServer = grpc.ClientStreamingServer[OpenStackState_RequestItem, OpenStackState_Response]
...
func _Stacks_PlanStackChanges_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(StacksServer).PlanStackChanges(m, &grpc.GenericServerStream[PlanStackChanges_Request, PlanStackChanges_Event]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type Stacks_PlanStackChangesServer = grpc.ServerStreamingServer[PlanStackChanges_Event]

func _Stacks_OpenPlan_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(StacksServer).OpenPlan(&grpc.GenericServerStream[OpenStackPlan_RequestItem, OpenStackPlan_Response]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type Stacks_OpenPlanServer = grpc.ClientStreamingServer[OpenStackPlan_RequestItem, OpenStackPlan_Response]
...
func _Stacks_ApplyStackChanges_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(StacksServer).ApplyStackChanges(m, &grpc.GenericServerStream[ApplyStackChanges_Request, ApplyStackChanges_Event]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type Stacks_ApplyStackChangesServer = grpc.ServerStreamingServer[ApplyStackChanges_Event]
...
func _Stacks_MigrateTerraformState_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(StacksServer).MigrateTerraformState(m, &grpc.GenericServerStream[MigrateTerraformState_Request, MigrateTerraformState_Event]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type Stacks_MigrateTerraformStateServer = grpc.ServerStreamingServer[MigrateTerraformState_Event]
