...
const message = {
    ...
    toolbox: {
        ...
        clam: {
            clam: 'Virus scan',
            cron: 'Scheduled scan',
            cronHelper: 'Pro supports scheduled scans',
            ...
            alertHelper: 'Pro supports scheduled scans and SMS alerts',
    ...
    setting: {
        ...
        proxyHelper1: 'Installation package downloads and App Store sync (Pro Edition only)',
        proxyHelper2: 'System updates and update checks (Pro Edition only)',
        proxyHelper3: 'System license verification and synchronization',
        proxyHelper4: 'Network requests such as Docker image pulls go through the proxy server (Pro Edition only)',
        proxyHelper5: 'Unified download and sync for system script libraries (Pro Edition)',
        proxyHelper6: 'Certificate requests (Pro Edition)',
    ...
    license: {
        ...
        lostHelper:
            'The license has reached the retry limit. Click Sync manually to make sure Pro features continue to work.',
        exceptionalHelper:
            'License sync verification failed. Click Sync manually to make sure Pro features work properly. Detail: ',
        ...
        waf: 'Upgrade to Pro to unlock interception maps, logs, block records, geo-blocking, custom rules, custom block pages, and more.',
        tamper: 'Upgrade to Pro to protect websites from unauthorized changes or tampering.',
        tamperHelper: 'Operation failed, the file or folder has tamper protection enabled. Please check and try again!',
        setting: 'Upgrade to Pro to customize the panel logo, welcome message, and more.',
        monitor:
            'Upgrade to Pro to view real-time website status, visitor trends, traffic sources, request logs, and more.',
        alert: 'Upgrade to Pro to receive SMS alerts, review alert logs, and stay on top of key events.',
        node: 'Upgrade to Pro Edition to manage multiple Linux servers in 1Panel.',
        nodeApp: 'Upgrade to Pro Edition to upgrade multi-node app versions without switching nodes manually.',
        nodeDashboard:
            'Upgrade to Pro Edition for centralized management of multi-node apps, websites, databases, and scheduled tasks.',
        fileExchange: 'Upgrade to Pro Edition to transfer files quickly between servers.',
    ...
    xpack: {
        ...
        alert: {
            ...
            licenseHelper: 'Pro supports additional alert channels',
            ...
            alertConfigProHelper: 'Pro Edition also supports WeCom, DingTalk, Feishu, and SMS alerts.',
        },
        theme: {
