...
const message = {
    ...
    toolbox: {
        ...
        clam: {
            clam: 'ウイルススキャン',
            cron: 'スケジュールされたスキャン',
            cronHelper: 'Pro 版は定期スキャンに対応しています',
            ...
            alertHelper: 'Pro 版は定期スキャンと SMS アラートに対応しています',
    ...
    setting: {
        ...
        proxyHelper1: 'アプリストアからのインストールパッケージのダウンロードと同期（Pro 版のみ）',
        proxyHelper2: 'システムアップデートと更新情報の取得（Pro 版のみ）',
        proxyHelper4:
            'Docker イメージの取得などのネットワークリクエストはプロキシサーバー経由で処理されます（Pro 版のみ）',
        proxyHelper5: 'システム系スクリプトライブラリの一括ダウンロードと同期（Pro 版機能）',
    ...
    license: {
        ...
        introduce: '機能の紹介',
        waf: 'Pro 版にアップグレードすると、インターセプトマップ、ログ、ブロック記録、地域ブロック、カスタムルール、カスタムブロックページなどを利用できます。',
        tamper: 'Pro 版にアップグレードすると、Web サイトを不正な変更や改ざんから保護できます。',
        setting: 'Pro 版にアップグレードすると、パネルロゴ、ウェルカムメッセージなどをカスタマイズできます。',
        monitor:
            'Pro 版にアップグレードすると、Web サイトのリアルタイム状態、訪問者トレンド、流入元、リクエストログなどを確認できます。',
        alert: 'Pro 版にアップグレードすると、SMS アラートの受信やアラートログの確認が可能になります。',
        app: 'Pro 版にアップグレードすると、モバイルアプリでサービス情報や異常監視を確認できます。',
        node: 'Pro Edition にアップグレードすると、1Panel で複数の Linux サーバーを管理できます。',
        nodeApp:
            'Pro Edition にアップグレードすると、ノードを手動で切り替えずにマルチノードアプリのバージョンを一括アップグレードできます。',
        nodeDashboard:
    ...
    xpack: {
        ...
        alert: {
            ...
            alertConfigProHelper: 'Pro 版では、WeCom、DingTalk、Feishu、SMS 通知も利用できます。',
        },
        theme: {
