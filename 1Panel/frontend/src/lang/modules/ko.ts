...
const message = {
    ...
    setting: {
        ...
        proxyHelper1: '설치 패키지 다운로드 및 앱 스토어 동기화 (Pro Edition 전용)',
        proxyHelper2: '시스템 업데이트 및 업데이트 정보 확인 (Pro Edition 전용)',
        proxyHelper4: 'Docker 이미지 pull 같은 네트워크 요청은 프록시 서버를 통해 처리됩니다 (Pro Edition 전용)',
        proxyHelper3: '시스템 라이선스 인증 및 동기화',
        proxyHelper5: '시스템 스크립트 라이브러리 통합 다운로드 및 동기화 (Pro Edition 기능)',
    ...
    license: {
        ...
        introduce: '기능 소개',
        waf: 'Pro로 업그레이드하면 차단 맵, 로그, 차단 기록, 지역 차단, 사용자 정의 규칙, 사용자 정의 차단 페이지 등을 사용할 수 있습니다.',
        tamper: 'Pro로 업그레이드하면 웹사이트를 무단 수정이나 변조로부터 보호할 수 있습니다.',
        setting: 'Pro로 업그레이드하면 패널 로고, 환영 메시지 등 정보를 사용자 정의할 수 있습니다.',
        monitor:
            'Pro로 업그레이드하면 웹사이트의 실시간 상태, 방문자 추세, 유입 경로, 요청 로그 등을 확인할 수 있습니다.',
        alert: 'Pro로 업그레이드하면 SMS 알림을 받고 알림 로그를 확인할 수 있습니다.',
        node: 'Pro Edition으로 업그레이드하면 1Panel에서 여러 Linux 서버를 관리할 수 있습니다.',
        nodeApp:
            'Pro Edition으로 업그레이드하면 노드를 수동으로 전환하지 않고도 다중 노드 애플리케이션 버전을 일괄 업그레이드할 수 있습니다.',
        nodeDashboard:
            'Pro Edition으로 업그레이드하면 다중 노드 애플리케이션, 웹사이트, 데이터베이스, 예약 작업을 중앙에서 관리할 수 있습니다.',
    ...
    xpack: {
        ...
        alert: {
            ...
            alertConfigProHelper: 'Pro에서는 WeCom, DingTalk, Feishu, SMS 알림도 지원합니다.',
        },
        theme: {
