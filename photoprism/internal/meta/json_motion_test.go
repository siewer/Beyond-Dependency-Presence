...
func TestJSON_Motion(t *testing.T) {
	t.Run("GooglePixel2JpgJson", func(t *testing.T) {
		...
		assert.Equal(t, "2018-03-18 19:21:15.79694 +0000 UTC", data.TakenAtLocal.String())
		assert.Equal(t, "2018-03-18 23:21:15.79694 +0000 UTC", data.TakenAt.String())
	...
	t.Run("GooglePixel4aJpgJson", func(t *testing.T) {
		...
		assert.Equal(t, int64(0), data.Duration.Milliseconds())
		assert.Equal(t, "0s", data.Duration.String())
		assert.Equal(t, "2021-09-17 19:31:36.844 +0000 UTC", data.TakenAtLocal.String())
		assert.Equal(t, "2021-09-17 23:31:36.844 +0000 UTC", data.TakenAt.String())
	...
	t.Run("GooglePixel6JpgJson", func(t *testing.T) {
		...
		assert.Equal(t, int64(0), data.Duration.Milliseconds())
		assert.Equal(t, "0s", data.Duration.String())
		assert.Equal(t, "2021-12-27 16:13:22.429 +0000 UTC", data.TakenAtLocal.String())
		assert.Equal(t, "2021-12-27 15:13:22.429 +0000 UTC", data.TakenAt.String())
	...
	t.Run("GooglePixel7proJpgJson", func(t *testing.T) {
		...
		assert.Equal(t, int64(0), data.Duration.Milliseconds())
		assert.Equal(t, "0s", data.Duration.String())
		assert.Equal(t, "2023-03-29 15:48:43.201 +0000 UTC", data.TakenAtLocal.String())
		assert.Equal(t, "2023-03-29 14:48:43.201 +0000 UTC", data.TakenAt.String())
	...
	t.Run("SamsungGalaxys20JpgJson", func(t *testing.T) {
		...
		assert.Equal(t, int64(0), data.Duration.Milliseconds())
		assert.Equal(t, "0s", data.Duration.String())
		assert.Equal(t, "2023-08-22 14:38:03.583 +0000 UTC", data.TakenAtLocal.String())
		assert.Equal(t, "2023-08-22 14:38:03.583 +0000 UTC", data.TakenAt.String())
	...
	t.Run("SamsungGalaxya71JpgJson", func(t *testing.T) {
		...
		assert.Equal(t, "2023-04-24 13:03:58.308 +0000 UTC", data.TakenAtLocal.String())
		assert.Equal(t, "2023-04-24 13:03:58.308 +0000 UTC", data.TakenAt.String())
		assert.Equal(t, "UTC+2", data.TimeZone)
		assert.Equal(t, "+02:00", data.TimeOffset)
