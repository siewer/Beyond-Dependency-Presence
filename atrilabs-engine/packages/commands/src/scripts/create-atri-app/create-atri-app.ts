  ...
  const str = JSON.stringify(
    {
      ...
      dependencies: {
        "@atrilabs/compat": "^1.0.0-alpha.37",
        "@atrilabs/atri-app-core": "^1.0.0-alpha.37",
        "@atrilabs/canvas-zone": "^1.0.0-alpha.37",
        "@atrilabs/commands": "^1.0.0-alpha.37",
        "@atrilabs/commands-builder": "^1.0.0-alpha.37",
        "@atrilabs/core": "^1.0.0-alpha.37",
        "@atrilabs/design-system": "^1.0.0-alpha.37",
        "@atrilabs/pwa-builder": "^1.0.0-alpha.37",
        "@atrilabs/pwa-builder-server": "^1.0.0-alpha.37",
        "@atrilabs/react-component-manifests": "^1.0.0-alpha.37",
        "@atrilabs/utils": "^1.0.0-alpha.37",
        "cross-env": "^7.0.3",
        "node-noop": "^1.0.0",
        react: "18.2.0",
        "react-dom": "18.2.0",
