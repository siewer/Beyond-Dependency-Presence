...
/**
 * Iterator End Node Processor
 * <p>
 * This processor is responsible for handling the end node in an iterator workflow. It
 * manages the finalization of iteration, result aggregation, and task status updates.
 * <p>
 * Features: 1. Finalizes iteration execution 2. Aggregates results and updates task
 * status 3. Handles node result and error propagation 4. Maintains node execution timing
 *
 * @author guning.lt
 * @version 1.0.0-M1
 */
@Slf4j
@Component("IteratorEndExecuteProcessor")
public class IteratorEndExecuteProcessor extends AbstractExecuteProcessor {

	/**
	 * Constructor for IteratorEndExecuteProcessor
	 ...
	 */
	public IteratorEndExecuteProcessor(RedisManager redisManager, WorkflowInnerService workflowInnerService,
	...
	/**
	 * Execute the iterator end node processing
	...
	/**
	 * Iterator end node does not need to handle variable values
	 */
	@Override
	...
	/**
	 * Special handling for end node in iteration body
	 * @param graph The workflow graph
	...
	public String getNodeType() {
		return NodeTypeEnum.ITERATOR_END.getCode();
	}

	@Override
	public String getNodeDescription() {
		return NodeTypeEnum.ITERATOR_END.getDesc();
	}
