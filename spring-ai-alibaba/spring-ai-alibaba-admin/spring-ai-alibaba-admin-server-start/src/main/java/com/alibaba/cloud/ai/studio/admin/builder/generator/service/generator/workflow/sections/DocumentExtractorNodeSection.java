...
import com.alibaba.cloud.ai.studio.admin.builder.generator.model.workflow.nodedata.DocumentExtractorNodeData;
...
public class DocumentExtractorNodeSection implements NodeSection<DocumentExtractorNodeData> {
	...
	public String render(Node node, String varName) {
		...
		List<com.alibaba.cloud.ai.studio.admin.builder.generator.model.VariableSelector> inputs = data.getInputs();
