...
public class SaaBrowserKeyPresser extends BaseSandboxAwareTool<PressKeyTool, SaaBrowserKeyPresser.PressKeyToolRequest, SaaBrowserKeyPresser.PressKeyToolResponse> {
	public SaaBrowserKeyPresser() {
	...
	public RuntimeFunctionToolCallback<?, ?> buildTool() {
		...
		return RuntimeFunctionToolCallback
				...
				.inputSchema(
						inputSchema
				).inputType(PressKeyToolRequest.class)
