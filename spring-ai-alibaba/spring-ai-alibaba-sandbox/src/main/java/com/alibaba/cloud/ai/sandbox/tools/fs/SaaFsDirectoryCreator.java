...
public class SaaFsDirectoryCreator extends BaseSandboxAwareTool<CreateDirectoryTool, SaaFsDirectoryCreator.CreateDirectoryToolRequest, SaaFsDirectoryCreator.CreateDirectoryToolResponse> {
    public SaaFsDirectoryCreator() {
    ...
    public record CreateDirectoryToolRequest(
            @JsonProperty(required = true, value = "path")
            @JsonPropertyDescription("Path to the directory to create")
            String path
    ) {
        public CreateDirectoryToolRequest(String path) {
            this.path = path;
        }
    }

    public record CreateDirectoryToolResponse(@JsonProperty("Response") Response output) {
        public CreateDirectoryToolResponse(Response output) {
            this.output = output;
        }
    }
    ...
    public RuntimeFunctionToolCallback<?, ?> buildTool() {
        ...
        return RuntimeFunctionToolCallback
                ...
                .inputSchema(
                        inputSchema
                ).inputType(CreateDirectoryToolRequest.class)
