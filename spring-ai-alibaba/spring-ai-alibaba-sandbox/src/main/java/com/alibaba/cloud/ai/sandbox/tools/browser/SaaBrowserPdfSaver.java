...
public class SaaBrowserPdfSaver extends BaseSandboxAwareTool<PdfSaveTool, SaaBrowserPdfSaver.PdfSaveToolRequest, SaaBrowserPdfSaver.PdfSaveToolResponse> {
    public SaaBrowserPdfSaver() {
    ...
    public RuntimeFunctionToolCallback<?, ?> buildTool() {
        ...
        return RuntimeFunctionToolCallback
                ...
                .inputSchema(
                        inputSchema
                ).inputType(PdfSaveToolRequest.class)
