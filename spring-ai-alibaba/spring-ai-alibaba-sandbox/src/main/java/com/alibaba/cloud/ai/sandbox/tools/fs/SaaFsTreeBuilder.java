...
public class SaaFsTreeBuilder extends BaseSandboxAwareTool<DirectoryTreeTool, SaaFsTreeBuilder.DirectoryTreeToolRequest, SaaFsTreeBuilder.DirectoryTreeToolResponse> {
    public SaaFsTreeBuilder() {
    ...
    public RuntimeFunctionToolCallback<?, ?> buildTool() {
        ...
        return RuntimeFunctionToolCallback
                ...
                .inputSchema(
                        inputSchema
                ).inputType(DirectoryTreeToolRequest.class)
