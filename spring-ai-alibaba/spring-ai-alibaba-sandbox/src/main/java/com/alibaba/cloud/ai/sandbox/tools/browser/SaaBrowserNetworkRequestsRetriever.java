...
public class SaaBrowserNetworkRequestsRetriever extends BaseSandboxAwareTool<NetworkRequestsTool, SaaBrowserNetworkRequestsRetriever.NetworkRequestsToolRequest, SaaBrowserNetworkRequestsRetriever.NetworkRequestsToolResponse> {
    public SaaBrowserNetworkRequestsRetriever() {
    ...
    public RuntimeFunctionToolCallback<?, ?> buildTool() {
        ...
        return RuntimeFunctionToolCallback
                ...
                .inputSchema(
                        inputSchema
                ).inputType(NetworkRequestsToolRequest.class)
