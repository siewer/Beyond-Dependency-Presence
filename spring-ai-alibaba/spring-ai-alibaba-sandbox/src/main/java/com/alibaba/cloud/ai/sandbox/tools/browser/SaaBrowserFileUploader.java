...
public class SaaBrowserFileUploader extends BaseSandboxAwareTool<FileUploadTool, SaaBrowserFileUploader.FileUploadToolRequest, SaaBrowserFileUploader.FileUploadToolResponse> {
    public SaaBrowserFileUploader() {
    ...
    public record FileUploadToolRequest(
            @JsonProperty(required = true, value = "paths")
            @JsonPropertyDescription("The absolute paths to the files to upload")
            String[] paths
    ) {
        public FileUploadToolRequest(String[] paths) {
            this.paths = paths;
        }
    }

    public record FileUploadToolResponse(@JsonProperty("Response") Response output) {
        public FileUploadToolResponse(Response output) {
            this.output = output;
        }
    }
    ...
    public RuntimeFunctionToolCallback<?, ?> buildTool() {
        ...
        return RuntimeFunctionToolCallback
                ...
                .inputSchema(
                        inputSchema
                ).inputType(FileUploadToolRequest.class)
