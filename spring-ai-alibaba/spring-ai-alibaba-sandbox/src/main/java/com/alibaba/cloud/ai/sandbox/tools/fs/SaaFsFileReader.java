...
public class SaaFsFileReader extends BaseSandboxAwareTool<ReadFileTool, SaaFsFileReader.ReadFileToolRequest, SaaFsFileReader.ReadFileToolResponse> {
    public SaaFsFileReader() {
    ...
    public RuntimeFunctionToolCallback<?, ?> buildTool() {
        ...
        return RuntimeFunctionToolCallback
                ...
                .inputSchema(
                        inputSchema
                ).inputType(ReadFileToolRequest.class)
