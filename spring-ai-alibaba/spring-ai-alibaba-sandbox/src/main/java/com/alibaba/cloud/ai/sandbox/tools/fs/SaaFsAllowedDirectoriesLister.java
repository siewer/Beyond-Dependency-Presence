...
public class SaaFsAllowedDirectoriesLister extends BaseSandboxAwareTool<ListAllowedDirectoriesTool, SaaFsAllowedDirectoriesLister.ListAllowedDirectoriesToolRequest, SaaFsAllowedDirectoriesLister.ListAllowedDirectoriesToolResponse> {
    public SaaFsAllowedDirectoriesLister() {
    ...
    public RuntimeFunctionToolCallback<?, ?> buildTool() {
        ...
        return RuntimeFunctionToolCallback
                ...
                .inputSchema(
                        inputSchema
                ).inputType(ListAllowedDirectoriesToolRequest.class)
