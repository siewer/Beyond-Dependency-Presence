...
public class SaaFsDirectoryLister extends BaseSandboxAwareTool<ListDirectoryTool, SaaFsDirectoryLister.ListDirectoryToolRequest, SaaFsDirectoryLister.ListDirectoryToolResponse> {
    public SaaFsDirectoryLister() {
    ...
    public RuntimeFunctionToolCallback<?, ?> buildTool() {
        ...
        return RuntimeFunctionToolCallback
                ...
                .inputSchema(
                        inputSchema
                ).inputType(ListDirectoryToolRequest.class)
