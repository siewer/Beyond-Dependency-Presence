...
public class SaaBrowserWaiter extends BaseSandboxAwareTool<WaitForTool, SaaBrowserWaiter.WaitForToolRequest, SaaBrowserWaiter.WaitForToolResponse> {
    public SaaBrowserWaiter() {
    ...
    public RuntimeFunctionToolCallback<?, ?> buildTool() {
        ...
        return RuntimeFunctionToolCallback
                ...
                .inputSchema(
                        inputSchema
                ).inputType(WaitForToolRequest.class)
