...
public class SaaBrowserConsoleMessagesRetriever extends BaseSandboxAwareTool<ConsoleMessagesTool, SaaBrowserConsoleMessagesRetriever.ConsoleMessagesToolRequest, SaaBrowserConsoleMessagesRetriever.ConsoleMessagesToolResponse> {

    public SaaBrowserConsoleMessagesRetriever() {
    ...
    public RuntimeFunctionToolCallback<?, ?> buildTool() {
        ...
        return RuntimeFunctionToolCallback
                ...
                .inputSchema(
                        inputSchema
                ).inputType(ConsoleMessagesToolRequest.class)
