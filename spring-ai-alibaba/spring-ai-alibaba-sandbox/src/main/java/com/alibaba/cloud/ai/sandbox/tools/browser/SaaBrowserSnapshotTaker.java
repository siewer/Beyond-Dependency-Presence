...
public class SaaBrowserSnapshotTaker extends BaseSandboxAwareTool<SnapshotTool, SaaBrowserSnapshotTaker.SnapshotToolRequest, SaaBrowserSnapshotTaker.SnapshotToolResponse> {
    public SaaBrowserSnapshotTaker() {
    ...
    public RuntimeFunctionToolCallback<?, ?> buildTool() {
        ...
        return RuntimeFunctionToolCallback
                ...
                .inputSchema(
                        inputSchema
                ).inputType(SnapshotToolRequest.class)
