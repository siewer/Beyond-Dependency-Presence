...
public class SaaBrowserTabLister extends BaseSandboxAwareTool<TabListTool, SaaBrowserTabLister.TabListToolRequest, SaaBrowserTabLister.TabListToolResponse> {
    public SaaBrowserTabLister() {
    ...
    public RuntimeFunctionToolCallback<?, ?> buildTool() {
        ...
        return RuntimeFunctionToolCallback
                ...
                .inputSchema(
                        inputSchema
                ).inputType(TabListToolRequest.class)
