...
public class SaaBrowserCloser extends BaseSandboxAwareTool<CloseTool, SaaBrowserCloser.CloseToolRequest, SaaBrowserCloser.CloseToolResponse> {
    public SaaBrowserCloser() {
        super(new CloseTool());
    }
    ...
    public RuntimeFunctionToolCallback<?, ?> buildTool() {
        ...
        return RuntimeFunctionToolCallback
                ...
                .inputSchema(
                        inputSchema
                ).inputType(CloseToolRequest.class)
