...
public class SaaBrowserTabCloser extends BaseSandboxAwareTool<TabCloseTool, SaaBrowserTabCloser.TabCloseToolRequest, SaaBrowserTabCloser.TabCloseToolResponse> {
    public SaaBrowserTabCloser() {
    ...
    public RuntimeFunctionToolCallback<?, ?> buildTool() {
        ...
        return RuntimeFunctionToolCallback
                ...
                .inputSchema(
                        inputSchema
                ).inputType(TabCloseToolRequest.class)
