...
public class SaaBrowserScreenshotTaker extends BaseSandboxAwareTool<TakeScreenshotTool, SaaBrowserScreenshotTaker.TakeScreenshotToolRequest, SaaBrowserScreenshotTaker.TakeScreenshotToolResponse> {
    public SaaBrowserScreenshotTaker() {
    ...
    public RuntimeFunctionToolCallback<?, ?> buildTool() {
        ...
        return RuntimeFunctionToolCallback
                ...
                .inputSchema(
                        inputSchema
                ).inputType(TakeScreenshotToolRequest.class)
