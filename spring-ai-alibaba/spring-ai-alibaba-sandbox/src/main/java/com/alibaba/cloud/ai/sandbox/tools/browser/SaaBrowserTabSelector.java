...
public class SaaBrowserTabSelector extends BaseSandboxAwareTool<TabSelectTool, SaaBrowserTabSelector.TabSelectToolRequest, SaaBrowserTabSelector.TabSelectToolResponse> {
    public SaaBrowserTabSelector() {
    ...
    public RuntimeFunctionToolCallback<?, ?> buildTool() {
        ...
        return RuntimeFunctionToolCallback
                ...
                .inputSchema(
                        inputSchema
                ).inputType(TabSelectToolRequest.class)
