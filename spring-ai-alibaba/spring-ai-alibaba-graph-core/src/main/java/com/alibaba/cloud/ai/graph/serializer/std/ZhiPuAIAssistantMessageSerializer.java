...
class ZhiPuAIAssistantMessageSerializer implements NullableObjectSerializer<ZhiPuAiAssistantMessage> {

	public ZhiPuAIAssistantMessageSerializer() {
	}

	@Override
	public void write(ZhiPuAiAssistantMessage object, ObjectOutput out) throws IOException {
	...
	public ZhiPuAiAssistantMessage read(ObjectInput in) throws IOException, ClassNotFoundException {
