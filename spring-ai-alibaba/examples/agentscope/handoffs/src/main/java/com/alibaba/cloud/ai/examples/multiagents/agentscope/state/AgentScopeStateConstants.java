 ...
 */
package com.alibaba.cloud.ai.examples.multiagents.agentscope.state;

/**
 * State keys and agent names for the AgentScope multi-agent handoffs workflow (sales + support).
 */
