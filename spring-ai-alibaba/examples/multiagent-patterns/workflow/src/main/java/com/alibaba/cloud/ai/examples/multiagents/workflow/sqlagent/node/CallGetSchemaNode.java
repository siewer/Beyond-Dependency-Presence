...
/**
 * Forces the model to call sql_db_schema (tool_choice=any). Equivalent to call_get_schema.
 */
public class CallGetSchemaNode implements NodeAction {
	...
	public CallGetSchemaNode(ChatModel chatModel, SqlTools sqlTools) {
	...
	public Map<String, Object> apply(OverAllState state) throws Exception {
		...
		return Map.of("messages", List.of(response), "llm_response", response);
	}
}
