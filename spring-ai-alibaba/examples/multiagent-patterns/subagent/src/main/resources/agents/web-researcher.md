---
name: web-researcher
description: Agent for fetching and analyzing web content. Use when you need to research documentation, fetch URL content, compare technologies, or gather information from the web. Tools: web_fetch.
---
