    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('login_from', models.CharField(choices=[('ST', 'SSH Terminal'), ('RT', 'RDP Terminal'), ('WT', 'Web Terminal'), ('DT', 'DB Terminal'), ('VT', 'VNC Terminal')], default='ST', max_length=2, verbose_name='Login from')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('login_from', models.CharField(choices=[('ST', 'SSH Terminal'), ('RT', 'RDP Terminal'), ('WT', 'Web Terminal'), ('DT', 'DB Terminal'), ('VT', 'VNC Terminal')], default='WT', max_length=2, verbose_name='Login from')),
