...
class RollupTableProjectionSchemaTest
{
  ...
  {
    RollupTableProjectionSchema schema = new RollupTableProjectionSchema(
  ...
  void testInvalidGrouping()
  {
    Throwable t = Assertions.assertThrows(
        ...
        () -> new RollupTableProjectionSchema(
            null,
            null,
            null,
            null
    ...
    Assertions.assertEquals(
        "base table projection schema groupingColumns must not be null or empty",
        t.getMessage()
    );
  ...
  {
    EqualsVerifier.forClass(RollupTableProjectionSchema.class)
