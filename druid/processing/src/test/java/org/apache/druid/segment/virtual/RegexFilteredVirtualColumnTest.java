...
public class RegexFilteredVirtualColumnTest
{
  ...
  {
    RegexFilteredVirtualColumn virtualColumn = new RegexFilteredVirtualColumn(
        "hello",
        new DefaultDimensionSpec("column", "output", ColumnType.STRING),
        "^.*abc$"
    );
    RegexFilteredVirtualColumn roundTrip = MAPPER.readValue(MAPPER.writeValueAsString(virtualColumn), RegexFilteredVirtualColumn.class);
