...
public class IndexMergerV10Factory
{
  ...
  // (this comment copied from v9 factory, but still true)
  private final SegmentWriteOutMediumFactory defaultSegmentWriteOutMediumFactory;

  @Inject
  public IndexMergerV10Factory(
      ObjectMapper mapper,
      IndexIO indexIO,
  ...
  public IndexMergerV10 create()
  {
    return new IndexMergerV10(mapper, indexIO, defaultSegmentWriteOutMediumFactory);
  }
}
