...
public class PrefixFilteredVirtualColumn implements VirtualColumn
{
  ...
  @JsonCreator
  public PrefixFilteredVirtualColumn(
  ...
  {
    CacheKeyBuilder builder = new CacheKeyBuilder(VirtualColumnCacheHelper.CACHE_TYPE_ID_PREFIX_FILTERED)
        .appendString(name)
  ...
  {
    return new PrefixFilteredDimensionSpec(
        delegate,
        prefix
  ...
  public int hashCode()
  {
    return Objects.hash(name, delegate, prefix);
  }

  @Override
  public String toString()
  {
    return "PrefixFilteredVirtualColumn{" +
           "name='" + name + '\'' +
           ", delegate=" + delegate +
           ", prefix='" + prefix + '\'' +
           '}';
