 ...
 */
public class HdfsToAzureParallelIndexTest extends AbstractHdfsInputSourceParallelIndexTest
{
  private static final Logger LOG = new Logger(HdfsToAzureParallelIndexTest.class);
  ...
  private final AzureStorageResource azureResource = new AzureStorageResource();
  ...
  protected void addResources(EmbeddedDruidCluster cluster)
  {
    ...
    // can read from HDFS. It does NOT configure Azure-overriding deep-storage properties.
