...
public class MSQLocalDurableStorage implements EmbeddedResource
{
  ...
  {
    final File baseDir = cluster.getTestFolder().getOrCreateFolder("msq-durable-storage");
    cluster.addCommonProperty("druid.msq.intermediate.storage.enable", "true")
           ...
           .addCommonProperty("druid.msq.intermediate.storage.basePath", baseDir.getAbsolutePath());
  }
