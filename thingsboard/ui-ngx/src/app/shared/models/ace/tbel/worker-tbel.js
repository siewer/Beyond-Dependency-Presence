...
ace.define("ace/mode/tbel/jshint",[], function(require, exports, module) {
...
ace.define("ace/mode/tbel_worker",[], function(require, exports, module) {
"use strict";

var oop = require("../lib/oop");
var Mirror = require("../worker/mirror").Mirror;
var lint = require("./tbel/jshint").JSHINT;
...
var TbelWorker = exports.TbelWorker = function(sender) {
    Mirror.call(this, sender);
    this.setTimeout(500);
    this.setOptions();
};

oop.inherits(TbelWorker, Mirror);
