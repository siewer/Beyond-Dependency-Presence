...
class TestOptionCreateView(PopUpObjectCreateMixin, WebTestCase):
    is_staff = True
    permissions = DashboardPermission.get("catalogue", "view_option", "add_option")
    model = Option
    form = OptionForm
...
class TestOptionUpdateView(PopUpObjectUpdateMixin, WebTestCase):
    is_staff = True
    permissions = DashboardPermission.get("catalogue", "view_option", "change_option")
    model = Option
    form = OptionForm
    page_title = None
...
class TestOptionDeleteView(PopUpObjectDeleteMixin, WebTestCase):
    is_staff = True
    permissions = DashboardPermission.get("catalogue", "view_option", "delete_option")
    model = Option
    page_title = None
