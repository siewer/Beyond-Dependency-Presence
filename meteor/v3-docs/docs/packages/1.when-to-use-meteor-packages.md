...
If your package depends on another Atmosphere package, or needs to take advantage of Meteor's [build system](/about/build-tool), writing an Atmosphere package might be the best option for now.
