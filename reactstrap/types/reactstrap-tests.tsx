...
class PopoverExampleMulti extends React.Component<
  any,
  { popovers: Array<{ placement: string; text: string }> }
> {
  ...
  return (
    <div>
      ...
      <Progress
        value="463"
        max={500}
        barAriaValueText="test"
        barAriaLabelledBy="test"
      />
...
class TooltipExampleMulti extends React.Component<any, any> {
  ...
  render() {
    return (
      <div>
        {this.state.tooltips.map(
          (tooltip: { placement: string; text: string }, i: number) => {
...
import {
  default as Button_,
  ButtonProps,
} from './lib/Button'; /* tslint:disable-line: no-relative-import-in-test */
...
const MegaTest = () => {
  return (
    <>
      <Alert ref={React.createRef<Alert>()} {...htmlProps} />
      <Badge ref={React.createRef<Badge>()} {...htmlProps} />
      <Breadcrumb ref={React.createRef<Breadcrumb>()} {...htmlProps} />
      <BreadcrumbItem ref={React.createRef<BreadcrumbItem>()} {...htmlProps} />
      <Button ref={React.createRef<Button>()} {...htmlProps} />
      <ButtonGroup ref={React.createRef<ButtonGroup>()} {...htmlProps} />
      <ButtonToggle ref={React.createRef<ButtonToggle>()} {...htmlProps} />
      <ButtonToolbar ref={React.createRef<ButtonToolbar>()} {...htmlProps} />
      <Card ref={React.createRef<Card>()} {...htmlProps} />
      <CardBody ref={React.createRef<CardBody>()} {...htmlProps} />
      <CardColumns ref={React.createRef<CardColumns>()} {...htmlProps} />
      <CardDeck ref={React.createRef<CardDeck>()} {...htmlProps} />
      <CardFooter ref={React.createRef<CardFooter>()} {...htmlProps} />
      <CardGroup ref={React.createRef<CardGroup>()} {...htmlProps} />
      <CardHeader ref={React.createRef<CardHeader>()} {...htmlProps} />
      <CardImg ref={React.createRef<CardImg>()} {...htmlProps} />
      <CardImgOverlay ref={React.createRef<CardImgOverlay>()} {...htmlProps} />
      <CardLink ref={React.createRef<CardLink>()} {...htmlProps} />
      <CardSubtitle ref={React.createRef<CardSubtitle>()} {...htmlProps} />
      <CardText ref={React.createRef<CardText>()} {...htmlProps} />
      <CardTitle ref={React.createRef<CardTitle>()} {...htmlProps} />
      <Carousel
      ...
      <CarouselIndicators
        ...
        activeIndex={1}
      />
      <CarouselItem ref={React.createRef<CarouselItem>()} {...htmlProps} />
      ...
      <DropdownToggle ref={React.createRef<DropdownToggle>()} {...htmlProps} />
      <Fade ref={React.createRef<Fade>()} {...htmlProps} />
      <Form ref={React.createRef<Form>()} {...htmlProps} />
      <FormFeedback ref={React.createRef<FormFeedback>()} {...htmlProps} />
      ...
      <ModalFooter ref={React.createRef<ModalFooter>()} {...htmlProps} />
      <ModalHeader ref={React.createRef<ModalHeader>()} {...htmlProps} />
      <Nav ref={React.createRef<Nav>()} {...htmlProps} />
      <NavItem ref={React.createRef<NavItem>()} {...htmlProps} />
      <NavLink ref={React.createRef<NavLink>()} {...htmlProps} />
      <Navbar ref={React.createRef<Navbar>()} {...htmlProps} />
      <NavbarBrand ref={React.createRef<NavbarBrand>()} {...htmlProps} />
      <NavbarText ref={React.createRef<NavbarText>()} {...htmlProps} />
      <NavbarToggler ref={React.createRef<NavbarToggler>()} {...htmlProps} />
      <Pagination ref={React.createRef<Pagination>()} {...htmlProps} />
      <PaginationItem ref={React.createRef<PaginationItem>()} {...htmlProps} />
      <PaginationLink ref={React.createRef<PaginationLink>()} {...htmlProps} />
      <Popover ref={React.createRef<Popover>()} {...htmlProps} target="a" />
      <PopoverBody ref={React.createRef<PopoverBody>()} {...htmlProps} />
      <PopoverHeader ref={React.createRef<PopoverHeader>()} {...htmlProps} />
      <Progress ref={React.createRef<Progress>()} {...htmlProps} />
      <Row ref={React.createRef<Row>()} {...htmlProps} />
      <Spinner ref={React.createRef<Spinner>()} {...htmlProps} />
      <TabContent ref={React.createRef<TabContent>()} {...htmlProps} />
      <TabPane ref={React.createRef<TabPane>()} {...htmlProps} />
      <Table ref={React.createRef<Table>()} {...htmlProps} />
      <Tag ref={React.createRef<Tag>()} {...htmlProps} />
      <Toast ref={React.createRef<Toast>()} {...htmlProps} target="a" />
      <ToastBody ref={React.createRef<ToastBody>()} {...htmlProps} />
      <ToastHeader ref={React.createRef<ToastHeader>()} {...htmlProps} />
      <Tooltip ref={React.createRef<Tooltip>()} {...htmlProps} target="a" />
    </>
  );
};
