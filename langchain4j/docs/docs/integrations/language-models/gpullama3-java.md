...
implementation 'dev.langchain4j:langchain4j-gpu-llama3:1.12.2-beta22'
```
---
## Model Compatibility
...
```bash
target/gpullama3.java-example-1.12.2-beta22.jar
```
...
CP="target/gpullama3.java-example-1.12.2-beta22.jar:$(cat cp.txt)"
