...
func (_m *MockOpenerBuilderImpls) Name() message.WALName {
	ret := _m.Called()
...
func (_c *MockOpenerBuilderImpls_Name_Call) Return(_a0 message.WALName) *MockOpenerBuilderImpls_Name_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockOpenerBuilderImpls_Name_Call) RunAndReturn(run func() message.WALName) *MockOpenerBuilderImpls_Name_Call {
	_c.Call.Return(run)
	return _c
}
