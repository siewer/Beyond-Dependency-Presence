...
describe('socketstream client library', function () {
    ...
    describe('#send', function () {
        ...
        it('should extend mods',function() {
            ...
            extra.path.should.be.equal(path.join(__dirname,'../../../../../lib/client/system/modules/','extra.js'));
            extra.dir.should.be.equal(path.join(__dirname,'../../../../../lib/client/system/modules'));
            ...
            extra2.path.should.be.equal(path.join(__dirname,'../../../../../lib/client/system/modules/','extra.js'));
            extra2.dir.should.be.equal(path.join(__dirname,'../../../../../lib/client/system/modules'));
