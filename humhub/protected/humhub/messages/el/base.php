...
return [
    ...
    'All' => 'Όλα',
    'Allow' => 'Επιτρέπω',
    'Allow content from external source' => 'Να επιτρέπεται περιχεόμενο από εξωτερική πηγή',
    'Always allow content from this provider!' => 'Να επιτρέπεται πάντα περιεχόμενο από αυτό τον πάροχο!',
    ...
    'Do you want to enable content from \'{urlPrefix}\'?' => 'Θέλετε να ενεργοποιήσετε περιεχόμενο από το \'{urlPrefix}\';',
    'Edit' => 'Επεξεργασία',
    'Error' => 'Σφάλμα',
