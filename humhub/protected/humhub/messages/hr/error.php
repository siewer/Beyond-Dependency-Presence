...
return array (
  ...
  'Maintenance mode activated: You have been automatically logged out and will no longer have access the platform until the maintenance has been completed.' => 'Aktiviran je način održavanja: Automatski ste odjavljeni i više nećete imati pristup platformi dok održavanje ne bude dovršeno.',
  'Maintenance mode is active. Only Administrators can access the platform.' => 'Aktiviran je način održavanja. Samo administratori mogu pristupiti platformi.',
  'The module {moduleId} is present in the HumHub configuration file even though this module is disabled. Please remove it from the configuration.' => 'Modul {moduleId} je prisutan u HumHub konfiguracijskoj datoteci iako je ovaj modul onemogućen. Molimo uklonite ga iz konfiguracije.',
  'The specified URL cannot be called directly.' => 'Navedeni URL ne može se izravno pozvati.',
  ...
  'You must change password.' => 'Morate promijeniti lozinku.',
