...
return [
    '<strong>Login</strong> required' => '<strong>Conectare</strong> necesară',
    'An internal server error occurred.' => 'O eroare internă de server a apărut.',
    'Guest mode not active, please login first.' => 'Modul oaspete nu este activ, te rugăm să te conectezi mai întâi.',
    'Login required for this section.' => 'Această acțiune necesită conectarea.',
    'You are not allowed to perform this action.' => 'Nu îți este permisă executarea acestei acțiuni.',
