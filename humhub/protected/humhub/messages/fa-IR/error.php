...
return [
    ...
    'An internal server error occurred.' => 'خطای داخلی سرور رخ داد.',
    'Guest mode not active, please login first.' => 'حالت مهمان فعال نیست، لطفا وارد شوید.',
    'Login required for this section.' => 'برای این بخش ورود ضروری است.',
    'You are not allowed to perform this action.' => 'شما مجاز به انجام این عملیات نیستید.',
    'You are not permitted to access this section.' => 'شما مجاز به دسترسی به این بخش نیستید.',
