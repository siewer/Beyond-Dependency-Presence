...
return array (
  ...
  'The module {moduleId} is present in the HumHub configuration file even though this module is disabled. Please remove it from the configuration.' => 'De module {moduleId} is aanwezig in het HumHub-configuratiebestand, ook al is deze module uitgeschakeld. Verwijder deze uit de configuratie.',
