...
return [
    '<strong>Login</strong> required' => 'Se requiere <strong>iniciar sesión</strong>',
    'An internal server error occurred.' => 'Ha ocurriu un error interno d\'o servidor.',
    'Guest mode not active, please login first.' => 'Modo de convidau no activo, per favor, inicia sesión primero.',
    'Login required for this section.' => 'Se requiere iniciar sesión pa ista sección.',
    'You are not allowed to perform this action.' => 'No yes permitiu pa fer ista acción.',
    'You are not permitted to access this section.' => 'No yes permitiu pa accedir a ista sección.',
