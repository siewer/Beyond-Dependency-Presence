...
return [
    ...
    'An unexpected error occurred. Please check whether your file exceeds the allowed upload limit of {maxUploadSize}.' => 'Ocorreu um erro inesperado. Por favor, verifique se o limite de carregamento (upload limit) {maxUploadSize} foi ultrapassado. .',
    ...
    'Collapse' => 'Recolher',
    'Confirm' => 'Confirmar',
    'Content Addon source must be instance of ContentActiveRecord or ContentAddonActiveRecord!' => 'Fonte de conteúdo de addon deve ser exemplo de ContentActiveRecord ou ContentAddonActiveRecord!',
