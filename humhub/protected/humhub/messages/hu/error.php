...
return [
    ...
    'Guest mode not active, please login first.' => 'A vendég mód nem engedélyezett, előbb jelentkezz be.',
    'Login required for this section.' => 'Bejelentkezés szükséges ehhez a szekcióhoz.',
    'Maintenance mode activated: You have been automatically logged out and will no longer have access the platform until the maintenance has been completed.' => 'Karbantartási mód aktiválva: Automatikusan kijelentkeztettünk, és a karbantartás befejezéséig nem férhetsz hozzá a platformhoz.',
    'Maintenance mode is active. Only Administrators can access the platform.' => 'A karbantartási mód aktív. Csak a rendszergazdák férhetnek hozzá a platformhoz.',
    'The specified URL cannot be called directly.' => 'A megadott URL nem hívható közvetlenül.',
    ...
    'You must change password.' => 'Változtasd meg a jelszavadat.',
