...
return [
    '<strong>Login</strong> required' => '<strong>Saioa</strong> hasi',
    'An internal server error occurred.' => 'Zerbitzariaren barne-errorea gertatu da.',
    'Guest mode not active, please login first.' => 'Gonbidatu modua ez dago aktibaturik, lehenik hasi saioa.',
    'Login required for this section.' => 'Atal honetarako saioa hasi behar duzu.',
    'Maintenance mode activated: You have been automatically logged out and will no longer have access the platform until the maintenance has been completed.' => 'Mantentze-modua aktibatuta: automatikoki deskonektatua izan zara eta ez duzu plataforman sartzerik izango mantentze-lanak amaitu arte.',
    'Maintenance mode is active. Only Administrators can access the platform.' => 'Mantentze-modua aktibatuta dago. Administratzaileak soilik sar daitezke plataformara.',
