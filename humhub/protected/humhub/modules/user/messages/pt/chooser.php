...
return array (
  ...
  'Select {n,plural,=1{item} other{items}}' => 'Seleciona {n,plural,=1{item} other{items}}',
  'Select {n,plural,=1{user} other{users}}' => 'Seleciona {n,plural,=1{user} other{users}}',
  'Select...' => 'Seleciona...',
  ...
  'Your search returned no matches.' => 'A tua pesquisa não encontrou resultados correspondentes',
);
