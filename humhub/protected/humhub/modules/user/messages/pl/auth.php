...
return [
    ...
    'An email has been sent to {emailAddress}. Please check your inbox to complete the registration.' => 'Email wysłano na adres {emailAddress}. Sprawdź odebrane pod kątem wiadomości umożliwiającej rejestrację.',
    'Back' => 'Wstecz',
    ...
    'Due to security reasons you are required to change your password in order to access the platform.' => 'Z powodów bezpieczeństwa musisz zmienić hasło dostępu do platformy.',
    ...
    'If you don\'t see the email, please check your spam folder.' => 'O ile nic nie doszło, sprawdź folder na spam.',
