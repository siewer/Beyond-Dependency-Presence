...
return [
    ...
    'Password Recovery' => 'パスワードの復旧',
    'Password recovery can only be initiated once every 10 minutes.' => 'パスワード復旧は10分間に1回のみ開始できます。',
    'Password recovery disabled. Please contact your system administrator.' => 'パスワード復旧が無効です。システム管理者に連絡してください。',
    'Permissions' => '権限',
    'Plain' => 'プレーンテキスト',
    'Profile' => 'プロフィール',
