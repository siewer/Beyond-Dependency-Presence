...
return [
    ...
    '<b>Your profile stream is still empty</b><br>Get started and post something...' => '<b>プロフィールストリームはまだ空です</b><br>初めて何かを投稿してください。',
    ...
    'Each line must be formatted as Key=>Value!' => '各行は、Key=&gt;Value としてフォーマットする必要があります。',
    ...
    'Last name' => '姓',
    'Link Prefix (e.g. https://, mailto:, tel://)' => 'リンクのプレフィックス (例：https:// , mailto: , tel://)',
    ...
    'Profile Field Category' => 'プロフィールフィールドカテゴリ',
    ...
    'This profile is disabled!' => 'このプロフィールは無効です。',
    'This profile is no longer available!' => 'このプロフィールは使用できなくなりました。',
