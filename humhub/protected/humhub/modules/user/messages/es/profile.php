...
return [
    ...
    'Each line must be formatted as Key=>Value!' => 'Cada línea debe tener el formato Clave=&gt;Valor',
    ...
    'This profile is disabled!' => '¡Este perfil está deshabilitado!',
    ...
    'Twig template that will be used to render this field. You can use the internal names as variables, e.g. `{{ firstname }} {{ lastname }}`' => 'Plantilla Twig que se utilizará para presentar este campo. Puedes utilizar nombre internos como variables, por ejemplo `{{ firstname }} {{ lastname }}`',
