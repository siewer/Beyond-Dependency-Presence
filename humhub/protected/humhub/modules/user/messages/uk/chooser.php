...
return [
    'An unexpected error occurred while loading the result.' => 'Під час завантаження результату сталася неочікувана помилка.',
    ...
    'Select...' => 'Виберіть...',
    'This field only allows a maximum of {n,plural,=1{# item} other{# items}}.' => 'Це поле дозволяє лише максимум {n,plural,=1{елемент} few{елемента} other{елементів}}',
