...
return array (
  ...
  'An unexpected error occurred while loading the result.' => 'При зареждането на резултата възникна неочаквана грешка.',
  'Load more' => 'Зареди още',
  'No results found.' => '',
  'No users found for the given query.' => 'Не са намерени потребители за дадената заявка.',
  'Please enter at least {n} character' => 'Моля, въведете поне {n} знака',
  'Select {n,plural,=1{item} other{items}}' => 'Избери {n,plural,=1{елемент} other{елементи}}',
