...
return array (
  ...
  'An unexpected error occurred while loading the result.' => 'Có lỗi không mong muốn xảy ra khi tải trang kết quả.',
  'Load more' => 'Tải thêm',
  'No results found.' => '',
  'No users found for the given query.' => 'Không tìm thấy người dùng theo tiêu chí tìm kiếm',
  'Please enter at least {n} character' => 'Vui lòng nhạp ít nhất {n} ký tự',
  'Select {n,plural,=1{item} other{items}}' => 'Chọn {n,plural,=1{item} other{items}}',
