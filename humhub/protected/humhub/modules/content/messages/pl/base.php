...
return [
  ...
  '(Also visible to people who are not logged in)' => '(Także widoczne dla osób, które nie są zalogowane)',
  '<strong>Delete</strong> content?' => '<strong>Skasować</strong> zawartość?',
  ...
  '<strong>Scheduling</strong> Options' => 'Opcje <strong>odkładania</strong>',
  'Activate scheduling' => 'Włącz odkładanie',
  'Add a member to notify' => 'Dodaj członka do powiadomienia',
  'Add tag...' => 'Dodaj znacznik...',
  'Advanced Content Search' => 'Wyszukiwanie zaawansowane',
  'Archived' => 'Zarchiwizowany',
  'Attach Files' => 'Załącz Pliki',
  'Back to stream' => 'Powrót do strumienia',
  'Cancel' => 'Anuluj',
  'Cancel Edit' => 'Anuluj Edycję',
  'Cannot notify the author.' => 'Nie można powiadomić autora.',
  ...
  'Create as draft' => 'Utwórz jako szkic',
  'Created at:' => 'Utworzono:',
  'Created by me' => 'Utworzone przez mnie',
  'Creation time' => 'Czas utworzenia',
  'Delete' => 'Usuń',
  'Deleted' => 'Usunięte',
  'Do you want to delete this content, including all comments and attachments?<br><br>Please note: If a stream entry was created using a module, the original content that this entry is linked to will also be deleted.' => 'Czy chcesz usunąć tę zawartość, w tym wszystkie komentarze i załączniki? <br><br>Uwaga: Jeśli wpis w strumieniu został utworzony przy użyciu modułu, oryginalna zawartość, z którą powiązany jest ten wpis, również zostanie usunięta.',
  'Draft' => 'Szkic',
  'Edit' => 'Edytuj',
  'Enable' => 'Włącz',
  'Enabled' => 'Aktywowane',
  ...
  'New Updates Available!' => 'Nowe aktualizacje dostępne!',
  ...
  'None' => 'Brak',
  'Note: Due to technical reasons there may be a delay of a few minutes.' => 'Notka: z racji uwarunkowań technicznych może wystąpić zwłoka do kilku minut.',
  ...
  'Save scheduling' => 'Zapisz odłożenie',
  'Schedule publication' => 'Odłóż publikację',
  'Scheduled for {dateTime}' => 'Odłóż do {dateTime}',
  'Select target Space.' => '',
  ...
  'The content cannot be published!' => 'Zawartość nie może zostać opublikowana!',
  'The content has been archived.' => 'Zawartość została zarchiwizowana.',
  'The content has been deleted.' => 'Zawartość została usunięta.',
  'The content has been successfully published.' => 'Zawartość została opublikowana.',
  ...
  'Topic already exists globally.' => 'Wątek już istnieje.',
  'Topic already in use in Spaces or on Profiles.' => 'Wątek już istnieje w przestrzeniach i profilach.',
  'Topics' => 'Tematy',
