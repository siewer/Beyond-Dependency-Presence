...
return [
    ...
    'You were added to Space {spaceName}' => '{spaceName} mekana eklendin',
    '{displayName} approved your membership for the space {spaceName}' => '{displayName}, {spaceName} mekanı için üyeliğinizi onayladı',
    '{displayName} requests membership for the space {spaceName}' => '{displayName}, {spaceName} mekanı için üyelik talep etti',
    'New Space' => '',
