...
return [
    ...
    'You are not a member of or following any Spaces.' => 'Не знайдено користувачів або спільнот.',
    'No Spaces found.' => 'Немає результатів пошуку задовільняючих Вашому запиту.',
    ...
    'Please enter at least {count} characters to search Spaces.' => 'Щоб знайти інші спільноти, введіть хоча б {count} літер.',
