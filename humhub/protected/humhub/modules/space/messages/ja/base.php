...
return [
    ...
    '<strong>Leave</strong> Space' => '<strong>スペースを残す</strong>',
    ...
    'Administrator:' => '管理者：',
    'Administrators' => '管理者',
    'Advanced Spaces Search' => '高度なスペース検索',
    'Any' => 'どれか',
    'Archived' => 'アーカイブ',
    'As owner you cannot revoke your membership!' => '所有者としてメンバーシップを取り消すことはできません',
    'Blocked users' => 'ブロックされたユーザー',
    'By Name' => '名前で',
    'Cancel' => 'キャンセル',
    'Change visibility' => '可視性を変更する',
    'Color' => '色',
    'Could not request membership!' => 'メンバーシップをリクエストできませんでした',
    ...
    'Following' => 'フォロー中',
    'Guests' => 'ゲスト',
    'Hide About Page' => 'アバウトページを非表示',
    'Hide Activity Sidebar Widget' => 'アクティビティ サイドバー ウィジェットを非表示',
    'Hide Followers' => 'フォロワーを非表示',
    'Hide Members' => 'メンバーを非表示',
    'Homepage' => 'ホームページ',
    'Homepage (Non-members)' => 'ホームページ（非会員）',
    'I want to become a member because...' => '会員になりたいので...',
    'Incorrect name, try again.' => '名前が間違っています。もう一度お試しください',
    'Invite' => '招待',
    ...
    'Pending' => '保留',
    'Pick users' => 'ユーザー選択',
    'Please note that any links you have previously created will become invalid as soon as you create a new one. Would you like to proceed?' => '以前に作成したリンクは、新しいリンクを作成するとすぐに無効になりますのでご注意ください。 続行しますか？',
    'Posts' => '投稿',
    'Private' => 'プライベート',
    ...
    'Send' => '送信',
    'Send the link via email' => 'メールでリンクを送信',
    'Settings' => '設定',
    ...
    'You can also invite external users by email, which are not registered now. Just add their e-mail addresses separated by comma.' => 'また現在登録されていない外部ユーザーをメールで招待することもできます。メール アドレスをコンマで区切って追加します。',
    'You can invite external users who are currently not registered via link. All you need to do is share this secure link with them.' => '現在登録されていない外部ユーザーをリンク経由で招待できます。 あなたがする必要があるのは、この安全なリンクを彼らと共有する事だけです。',
