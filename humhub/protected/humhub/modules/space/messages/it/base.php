...
return [
    ...
    'Following' => 'Seguo io',
    'Guests' => 'Ospiti',
    'Hide About Page' => 'Nascondi informazioni sulla pagina',
    'Hide Activity Sidebar Widget' => 'Nascondi il widget della barra laterale delle attività',
    'Hide Followers' => 'Nascondi follower',
    'Hide Members' => 'Nascondi membri',
    'Homepage' => 'Homepage',
    'Homepage (Non-members)' => 'Homepage (non membri)',
    'I want to become a member because...' => 'Voglio diventare un membro perché...',
    'Invite' => 'Invita',
    ...
    'Name' => 'Nome',
    'Name / Sort order' => 'Nome / Ordinamento',
    ...
    'Please note that any links you have previously created will become invalid as soon as you create a new one. Would you like to proceed?' => 'Si noti che i link creati in precedenza non saranno più validi non appena ne verrà creato uno nuovo. Volete procedere?',
    'Posts' => 'Articoli',
    'Private' => 'Privato',
    ...
    'Send' => 'Invia',
    'Send the link via email' => 'Invia il link tramite email',
    ...
    'Stream' => 'Stream',
    'Tags' => 'Tag',
    'The default homepage for members of this Space' => 'La homepage predefinita per i membri di questo Spazio',
    'The default homepage for non-members and guests visiting this Space' => 'La pagina iniziale predefinita per i non membri e gli ospiti che visitano questo spazio',
    'The secure link has been copied in your clipboard!' => 'Il link sicuro è stato copiato negli appunti!',
    ...
    'Warning: If you change the visibility settings of a Space from public to private, all content within that Space, including posts, comments, attachments etc. will also be set to private. This means that non-members will no longer be able to see, access, or interact with any of the content within that Space.' => 'Attenzione: Se si modificano le impostazioni di visibilità di uno Spazio da pubblico a privato, anche tutti i contenuti di quello Spazio, compresi i messaggi, i commenti, gli allegati ecc. saranno impostati come privati. Ciò significa che i non membri non potranno più vedere, accedere o interagire con i contenuti di quello Spazio.',
    ...
    'You can also invite external users by email, which are not registered now. Just add their e-mail addresses separated by comma.' => 'È possibile invitare via e-mail anche utenti esterni che non sono ancora registrati. Basta aggiungere i loro indirizzi e-mail separati da una virgola.',
    'You can invite external users who are currently not registered via link. All you need to do is share this secure link with them.' => 'È possibile invitare utenti esterni che non sono ancora registrati tramite un link. Tutto ciò che dovete fare è condividere con loro questo link sicuro.',
    ...
    'Your Message' => 'Messaggio dell\'applicazione',
