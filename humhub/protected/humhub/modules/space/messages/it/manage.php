...
return array (
  ...
  'Choose the modules you want to use for this Space. If you are undecided, you can also activate them later on via the Space settings.' => 'Scegli i moduli che desideri utilizzare per questo Spazio. Se sei indeciso, puoi attivarli anche in un secondo momento tramite le impostazioni di Spazio.',
  'Choose the modules you want to use for this Space. In order for the modules to be available to you here, they must have been previously installed by administrators of the network using the admin panel. If you cannot deactivate individual modules, it is because they have been set as the default for the entire network.' => 'Affinché i moduli siano disponibili qui, devono essere stati precedentemente installati dagli amministratori della rete utilizzando il pannello di amministrazione. Se non è possibile disattivare i singoli moduli, è perché sono stati impostati come predefiniti per l\'intera rete.',
  ...
  'Modules' => 'Moduli',
  'Next' => 'Avanti',
  'Only global administrators can change this value' => 'Solo gli amministratori globali possono modificare questo valore',
  'Owner' => 'Proprietario',
  ...
  'Removal of members queued' => 'Rimozione dei membri in coda',
  'Remove all members' => 'Rimuovi tutti i membri',
  ...
  'The URL has already been taken.' => 'L\'URL è già stato preso.',
