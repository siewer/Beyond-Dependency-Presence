...
return array (
  ...
  'All members excluding moderators and administrators of this Space will be removed. All pending invitations and membership requests will be terminated.' => 'Tous les membres de cet Espace seront retirés à l’exception des modérateurs, modératrices, administrateurs et administratrices. Toutes les invitations et demandes d’adhésion en attente seront annulées.',
  'Archive' => 'Archiver',
  ...
  'Hide posts on dashboard' => 'Ne pas afficher les publications de cet espace sur la vue d\'ensemble',
  'Invited By' => 'Invité par',
  'Members' => 'Membres',
  'Modules' => 'Modules',
  'Next' => 'Suivant',
  'Only global administrators can change this value' => 'Seuls les administrateurs et administratrices globales peuvent modifier cette valeur.',
  'Owner' => 'Propriétaire',
  ...
  'Removal of members queued' => 'Retrait des membres dans la file d’attente',
  'Remove all members' => 'Retirer tous les membres',
  'Remove from space' => 'Retirer de cet espace',
  'Role' => 'Rôle',
  'Security' => 'Sécurité',
  'Show all' => 'Afficher tout',
  'Show posts on dashboard' => 'Afficher les publications de cet espace sur la vue d\'ensemble',
