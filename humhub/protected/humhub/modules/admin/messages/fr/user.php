...
return [
  ...
  'Add Parent Group' => 'Ajouter un groupe parent',
  'Add Subgroup(s)' => 'Ajouter un(des) sous-groupe(s)',
...
' => 'Bonjour {displayName}, Votre demande de compte a été refusée. Cordialement {AdminName}',
  ...
  'Parent group is required!' => 'Le groupe de parents est requis !',
  ...
  'This user group includes {count} additional members from the subgroup(s). To view the subgroups, check the Settings section.' => 'Ce groupe d\'utilisateurs comprend {count} membres supplémentaires issus des sous-groupes. Pour consulter les sous-groupes, rendez-vous dans la section Paramètres.',
