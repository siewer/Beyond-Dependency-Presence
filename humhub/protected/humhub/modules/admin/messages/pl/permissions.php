...
return [
  ...
  'Can manage (e.g. edit or delete) all content (even private)' => 'Może zarządzać (zmieniać i kasować) całą zawartością (w tym prywatną)',
  ...
  'Manage All Content' => 'Zarządzaj całą zawartością',
