...
return [
  ...
  'Add Parent Group' => 'Übergeordnete Gruppe hinzufügen',
  'Add Subgroup(s)' => 'Untergruppe(n) hinzufügen',
...
{AdminName}',
  ...
  'Parent group is required!' => 'Übergeordnete Gruppe ist erforderlich!',
  'Password' => 'Passwort',
  ...
  'This user group includes {count} additional members from the subgroup(s). To view the subgroups, check the Settings section.' => 'Diese Benutzergruppe umfasst {count} weitere Mitglieder aus der/den Untergruppe(n). Um die Untergruppen anzuzeigen, prüfen Sie den Abschnitt „Einstellungen“.',
