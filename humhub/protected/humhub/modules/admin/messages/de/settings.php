...
return [
  ...
  '<strong>Mobile App</strong> Debug Page' => '<strong>Mobile App</strong> Debug-Seite',
  'A dedicated image can be uploaded in the Appearance admin page.' => 'Ein eigenes Bild kann auf der Administrationsseite „Erscheinungsbild“ hochgeladen werden.',
  ...
  'Allow establishing verified connections with the mobile app to enable Android app links and iOS universal links and redirect web content to the mobile app.' => 'Erlaubt das Herstellen verifizierter Verbindungen mit der mobilen App, um Android App Links und iOS Universal Links zu aktivieren und Webinhalte zur mobilen App weiterzuleiten.',
  ...
  'Base URL' => 'Basis-URL',
  'Caches flushed successfully' => 'Caches erfolgreich geleert',
  'Cannot compile SCSS to CSS:' => 'Kann SCSS nicht zu CSS kompilieren:',
  ...
  'Custom sort order (alphabetical if not defined)' => 'Benutzerdefinierte Sortierreihenfolge (alphabetisch, wenn nicht definiert)',
  'Custom sort order can be defined in the Space advanced settings.' => 'Eine benutzerdefinierte Sortierreihenfolge kann in den Einstellungen der Spaces definiert werden.',
  'DSN' => 'DSN',
  'DSN Examples:' => 'DSN Beispiele:',
  'Danger color' => 'Warnfarbe',
  ...
  'In order for links to open in the app on mobile devices, rather than in the mobile browser, all links (e.g. notification emails) need to be routed through the HumHub proxy server.' => 'Damit Links auf mobilen Geräten in der App und nicht im mobilen Browser geöffnet werden, müssen alle Links (z. B. in Benachrichtigungs-E-Mails) über den HumHub-Proxyserver geleitet werden.',
  'Info color' => 'Informationsfarbe',
  'Inserted script tags must contain a nonce. e.g. {code}' => 'Eingefügte Skript-Tags müssen ein nonce enthalten z.B. {code}.',
  'Invalid URL format: {domain}' => 'Ungültiges URL-Format: {domain}',
  ...
  'Maintenance mode restricts access to the platform and immediately logs out all users except Admins.' => 'Der Wartungsmodus schränkt den Zugriff auf die Plattform ein und meldet alle Benutzer außer Admins sofort ab.',
  ...
  'Recommended minimum height: {recommendedMinHeight}px (minimum {minWidth} x {minHeight} px).' => 'Empfohlene Mindesthöhe: {recommendedMinHeight}px (mindestens {minWidth} x {minHeight} px).',
  ...
  'Show network name instead of logo in email header' => 'Netzwerkname im E-Mail-Header anstelle des Logos anzeigen',
  ...
  'Well-known files' => 'Bekannte Dateien',
