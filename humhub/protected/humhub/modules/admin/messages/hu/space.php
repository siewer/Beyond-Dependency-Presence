...
return [
    ...
    'Default "Hide About Page"' => 'Alapértelmezett "Névjegy oldal elrejtése"',
    'Default "Hide Activity Sidebar Widget"' => 'Alapértelmezett "Tevékenység oldalsáv widget elrejtése"',
    'Default "Hide Followers"' => 'Alapértelmezett "Követők elrejtése"',
    'Default "Hide Members"' => 'Alapértelmezett "Tagok elrejtése"',
    'Default Content Visiblity' => 'Tartalom láthatóságának alapértelmezése',
    'Default Homepage' => 'Alapértelmezett kezdőlap',
    'Default Homepage (Non-members)' => 'Alapértelmezett kezdőlap (nem tagok)',
