...
return [
  ...
  'Add Groups...' => 'グループを追加...',
  'Add Parent Group' => '親グループを追加',
  'Add Subgroup(s)' => 'サブグループを追加',
  ...
  'All existing Profile Topics will be converted to Global Topics.' => '既存のプロフィールトピックはすべてグローバルトピックに変換されます。',
...
' => 'こんにちは{displayName}、あなたのアカウントリクエストは却下されました。 よろしくお願いいたします。{AdminName}',
  ...
  'Overview' => '概要',
  'Parent Group' => '親グループ',
  'Parent group is required!' => '親グループが必要です！',
  'Password' => 'パスワード',
  ...
  'Select which user information should be displayed in the \'People\' overview. You can select any profile fields, even those you have created individually. ' => '「人」ページに表示するユーザーの情報を選択します。 個別に作成したものでも、任意のプロフィールフィールドを選択できます。',
  'Send' => '送信',
  'Send & decline' => '送信＆却下',
  'Send & save' => '保存し送信',
  ...
  'This user group includes {count} additional members from the subgroup(s). To view the subgroups, check the Settings section.' => 'このユーザーグループには、サブグループから追加されたメンバーが{count}人含まれています。サブグループを確認するには、設定セクションをご覧ください。',
  ...
  'Will be used as a filter in \'People\'.' => '「人」ページでフィルターとして使用されます。',
  'Yes' => 'はい',
