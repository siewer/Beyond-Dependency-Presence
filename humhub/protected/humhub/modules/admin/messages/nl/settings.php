...
return [
  ...
  'A dedicated image can be uploaded in the Appearance admin page.' => 'U kunt een speciale afbeelding uploaden in het tabblad Weergave van Instellingen en configuratie.',
  ...
  'Email Header Image' => 'E-mailkopafbeelding',
  ...
  'Recommended minimum height: {recommendedMinHeight}px (minimum {minWidth} x {minHeight} px).' => 'Aanbevolen minimale hoogte: {recommendedMinHeight}px (minimum {minWidth} x {minHeight} px).',
  'Recommended size: {recommendedWidth} × {recommendedHeight}px (minimum {minWidth} x {minHeight} px).' => 'Aanbevolen grootte: {recommendedWidth} × {recommendedHeight}px (minimum {minWidth} x {minHeight} px).',
  ...
  'Show network name instead of logo in email header' => 'Toon netwerknaam in plaats van logo in e-mailkop',
