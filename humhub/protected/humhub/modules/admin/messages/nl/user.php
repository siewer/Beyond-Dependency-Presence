...
return [
  ...
  'About the account request for \'{displayName}\'.' => 'Over het accountverzoek voor \'{displayName}\'.',
  ...
  'Add Parent Group' => 'Bovenliggende groep toevoegen',
  'Add Subgroup(s)' => 'Subgroep(en) toevoegen',
  ...
  'Are you really sure? The selected users will be notified by e-mail.' => 'Weet u het zeker? De geselecteerde gebruikers worden per e-mail op de hoogte gebracht.',
  ...
  'Could not send the message to the user!' => 'Kan het bericht niet naar de gebruiker verzenden!',
  ...
  'Default content of the email when sending a message to the user' => 'Standaardinhoud van de e-mail bij het verzenden van een bericht naar de gebruiker',
  ...
  'Delete invitation?' => 'Uitnodiging verwijderen?',
  'Delete pending registrations?' => 'In afwachting zijnde registraties verwijderen?',
  ...
  'Do you really want to delete pending registrations?' => 'Wilt u de in behandeling zijnde registraties echt verwijderen?',
  'Do you really want to re-send the invitations to pending registration users?' => 'Wilt u de uitnodigingen naar gebruikers die nog moeten registreren, opnieuw verzenden?',
  'Edit' => 'Bewerk',
  ...
  'Email all selected' => 'E-mail alle geselecteerden',
  'Enable' => 'Activeer',
...
' => 'Hallo {displayName}, Het maken van uw account wordt beoordeeld. Kunt u ons de motivatie achter uw aanmelding vertellen? Met vriendelijke groet, {AdminName}',
  'Hello {displayName},
...
' => 'Hallo {displayName}, uw accountverzoek is afgewezen. Met vriendelijke groeten {AdminName}',
  ...
  'If enabled, the Group Manager will need to approve registration.' => 'Indien ingeschakeld, moet de groepsbeheerder de registratie goedkeuren.',
  ...
  'Overview' => 'Overzicht',
  'Parent Group' => 'Bovenliggende groep',
  'Parent group is required!' => 'Een bovenliggende groep is vereist',
  'Password' => 'Wachtwoord',
  ...
  'Post-registration approval required' => 'Goedkeuring na registratie vereist',
  ...
  'Re-send to all' => 'Opnieuw verzenden naar iedereen',
  ...
  'Resend invitations?' => 'Uitnodigingen opnieuw versturen?',
  'Save' => 'Bewaar',
  ...
  'Send a message to <strong>{displayName}</strong> ' => 'Stuur een bericht naar <strong>{displayName}</strong>',
  ...
  'The selected invitations have been successfully re-sent!' => 'De geselecteerde uitnodigingen zijn succesvol opnieuw verzonden!',
  'The user cannot be removed from this Group!' => 'De gebruiker kan niet uit deze groep worden verwijderd!',
  'The user cannot be removed from this Group, as users are required to be assigned to at least one Group.' => 'De gebruiker kan niet uit deze groep worden verwijderd, omdat gebruikers aan minimaal één groep moeten worden toegewezen.',
  'The user is the owner of these spaces:' => 'De gebruiker is de eigenaar van deze ruimtes.',
  'The users were notified by email.' => 'De gebruikers zijn per e-mail op de hoogte gesteld.',
  ...
  'This user group includes {count} additional members from the subgroup(s). To view the subgroups, check the Settings section.' => 'Deze gebruikersgroep bevat {count} extra leden uit de subgroep(en). Om de subgroepen te bekijken, raadpleegt u het gedeelte \'Instellingen\'.',
