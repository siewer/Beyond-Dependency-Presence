...
return [
  ...
  'Database' => 'Databank',
  'Database collation' => 'Databank-sortering',
  'Database driver - {driver}' => 'Databankstuurprogramma - {driver}',
  'Database migration results:' => 'Resultaten van de databank-migratie',
  'Delayed' => 'Uitgesteld',
  ...
  'Enable <a href="{url}">Link Redirection Service</a>' => '<a href="{url}">Link Redirection Service</a> inschakelen',
  'Error' => 'Fout',
  ...
  'Install {phpExtension} Extension for Mercure push live driver' => 'Installeer de {phpExtension}-extensie voor de Mercure push live-driver.',
  ...
  'Must be updated manually. Check compatibility with newer HumHub versions before updating.' => 'Moet handmatig worden bijgewerkt. Controleer de compatibiliteit met nieuwere HumHub-versies voordat u gaat vernieuwen.',
  'Never' => 'Nooit',
  ...
  'Optional' => 'Optioneel',
  'Other' => 'Andere',
  'Outstanding database migrations:' => 'Openstaande databank migraties:',
  'Permissions' => 'Rechten',
