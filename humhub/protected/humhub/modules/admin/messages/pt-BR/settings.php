...
return [
  ...
  'A dedicated image can be uploaded in the Appearance admin page.' => 'Uma imagem dedicada pode ser carregada na página de administração de Aparência.',
  ...
  'Base URL' => 'URL base',
  'Caches flushed successfully' => 'Caches liberados com sucesso',
  ...
  'Email Header Image' => 'Imagem do cabeçalho do e-mail',
  ...
  'Recommended minimum height: {recommendedMinHeight}px (minimum {minWidth} x {minHeight} px).' => 'Altura mínima recomendada: {recommendedMinHeight}px (mínimo {minWidth} x {minHeight} px).',
  'Recommended size: {recommendedWidth} × {recommendedHeight}px (minimum {minWidth} x {minHeight} px).' => 'Tamanho recomendado: {recommendedWidth} × {recommendedHeight} px (mínimo {minWidth} x {minHeight} px).',
  ...
  'Show network name instead of logo in email header' => 'Mostrar o nome da rede em vez do logotipo no cabeçalho do e-mail',
