...
return [
  ...
  'Add Parent Group' => 'Adicionar Grupo Pai',
  'Add Subgroup(s)' => 'Adicionar Subgrupo(s)',
  ...
  'All open registration invitations were successfully deleted.' => 'Todos os convites pendentes foram excluídos com sucesso.',
  'All open registration invitations were successfully re-sent.' => 'Todos os convites pendentes foram reenviados com sucesso.',
  ...
  'Cancel' => 'Cancelar',
  'Cannot resend invitation email!' => 'Não é possível reenviar o email de convite!',
...
Atenciosamente, {AdminName}',
  ...
  'List pending registrations' => 'Mostrar convites pendentes',
  ...
  'Members can invite external users by link' => 'Membros podem convidar usuários externos por link',
  'Message' => 'Mensagem',
  ...
  'Parent group is required!' => 'Grupo pai é obrigatório',
  'Password' => 'Senha',
  ...
  'The following list contains all pending sign-ups and invites.' => 'A lista a seguir contém todos os cadastros e convites pendentes.',
  ...
  'This user group includes {count} additional members from the subgroup(s). To view the subgroups, check the Settings section.' => 'Este grupo de usuários inclui {count} membros adicionais do(s) subgrupo(s). Para visualizar os subgrupos, consulte a seção Configurações.',
