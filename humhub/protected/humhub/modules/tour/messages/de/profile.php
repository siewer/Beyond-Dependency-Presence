...
return [
  ...
  '<strong>Edit</strong> account' => 'Einstellungen <strong>bearbeiten</strong>',
  '<strong>Hurray!</strong> The End.' => '<strong>Hurra!</strong> Fertig.',
  '<strong>Hurray!</strong> You\'re done!' => '<strong>Hurra!</strong> Du hast es geschafft!',
  ...
  'Click on this button to update your profile and account settings. You can also add more information to your profile.' => 'Klicke auf diesen Button, um dein Profil und deine Benutzerkonto-Einstellungen zu aktualisieren. Du kannst auch weitere Informationen zu deinem Profil hinzufügen.',
  ...
  'Just like in the space, the user profile can be personalized with various modules.<br><br>You can see which modules are available for your profile by looking them in "Modules" in the account settings menu.' => 'Genau wie im Space kann auch das Benutzerprofil mit verschiedenen Modulen personalisiert werden.<br><br>Welche Module für dein Profil verfügbar sind, siehst du unter „Module“ im Menü der Kontoeinstellungen.',
