<?php
return array (
  '<strong>Most recent</strong> activities' => '<strong>最新的</strong>活動',
  '<strong>Posts</strong>' => '<strong>貼文</strong>',
  '<strong>Profile Guide</strong>' => '',
  '<strong>Space</strong>' => '<strong>Space</strong>',
  '<strong>Space</strong> members' => '<strong>Space</strong>成員',
  '<strong>Space</strong> navigation menu' => '<strong>Space</strong>導覽選單',
  '<strong>Space</strong> preferences' => '<strong>Space</strong>偏好設定',
  '<strong>Writing</strong> posts' => '<strong>編寫</strong>貼文',
