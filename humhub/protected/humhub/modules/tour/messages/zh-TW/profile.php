...
return [
    '<strong>Administration (Modules)</strong>' => '<strong>管理設定 (模組)</strong>',
    '<strong>Edit</strong> account' => '<strong>編輯</strong>帳戶',
    '<strong>Profile</strong> menu' => '<strong>個人檔案</strong>選單',
    '<strong>Profile</strong> photo' => '<strong>個人檔案</strong>照片',
    '<strong>Profile</strong> stream' => '<strong>個人檔案</strong>塗鴉牆',
    '<strong>User profile</strong>' => '<strong>用戶個人檔案</strong>',
