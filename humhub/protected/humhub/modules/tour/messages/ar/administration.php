<?php
return array (
  '<strong>Administration</strong>' => '<strong> الإدارة </strong>',
  '<strong>Hurray!</strong> That\'s all for now.' => '<strong> مرحى </strong> هذا كل شيء الآن.',
  '<strong>Modules</strong>' => '<strong> الموديولات (الوحدات) </strong>',
  'As an admin, you can manage the whole platform from here.<br><br>Apart from the modules, we are not going to go into each point in detail here, as each has its own short description elsewhere.' => 'بصفتك مشرفًا ، يمكنك إدارة النظام الأساسي بالكامل من هنا. <br> <br> بصرف النظر عن الموديولات (الوحدات النمطية) ، لن نذهب إلى كل نقطة بالتفصيل هنا ، حيث أن لكل منها وصفًا قصيرًا خاصًا بها في مكان آخر.',
  'You are currently in the tools menu. From here you can access the HumHub online marketplace, where you can install an ever increasing number of tools on-the-fly.<br><br>As already mentioned, the tools increase the features available for your space.' => 'أنت حاليًا في قائمة الأدوات. من هنا يمكنك الوصول إلى سوق HumHub عبر الإنترنت ، حيث يمكنك تثبيت عدد متزايد من الأدوات أثناء التنقل. <br> <br> كما ذكرنا سابقًا ، تزيد الأدوات من الميزات المتوفرة لمساحتك.',
