<?php
return array (
  '<strong>Administration</strong>' => '<strong>Ylläpitäjän opastus</strong>',
  '<strong>Hurray!</strong> That\'s all for now.' => '<strong>Jipii!</strong> Siinä kaikki.',
  '<strong>Modules</strong>' => 'Laajennukset',
  'As an admin, you can manage the whole platform from here.<br><br>Apart from the modules, we are not going to go into each point in detail here, as each has its own short description elsewhere.' => 'Järjestelmän ylläpitäjänä voit hallita koko alustan täältä.<br><br>Laajenusten ohella emme aio mennä yksityiskohtaisesti kaikkiin asetuksiin, sillä kullakin on oma lyhyt kuvaus.',
  'You are currently in the tools menu. From here you can access the HumHub online marketplace, where you can install an ever increasing number of tools on-the-fly.<br><br>As already mentioned, the tools increase the features available for your space.' => 'Olet tällä hetkellä Hallintapaneelissa. Esimerkiksi tästä voit asentaa laajenuksia intraan.',
