<?php
return array (
  '<strong>Most recent</strong> activities' => '<strong>Actividatz</strong> mas recients',
  '<strong>Posts</strong>' => '<strong>Publicacions</strong>',
  ...
  '<strong>Space</strong> navigation menu' => '<strong>Menú</strong> de navegación',
  '<strong>Space</strong> preferences' => '<strong>Preferencias</strong> de l\'espacio',
  '<strong>Writing</strong> posts' => '<strong>Escribindo</strong> publicacions',
  '<strong>Yay! You\'re done.</strong>' => '',
  'All users who are a member of this space will be displayed here.<br /><br />New members can be added by anyone who has been given access rights by the admin.' => 'Totz os usuarios que sían miembros d\'iste espacio s\'amostrarán aquí.<br /><br /> Os nuevos miembros pueden ser adhibius per qualsiquier persona que tienga dreitos d\'administrador.',
