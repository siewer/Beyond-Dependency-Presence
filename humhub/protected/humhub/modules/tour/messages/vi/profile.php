...
return [
    ...
    '<strong>Edit</strong> account' => '<strong>Chỉnh sửa</strong> thông tin tài khoản',
    '<strong>Hurray!</strong> The End.' => '<strong>Hurra!!!</strong> Hoàn tất.',
    '<strong>Hurray!</strong> You\'re done!' => '<strong>Hurra!!!</strong> Bạn đã hoàn thành!',
    '<strong>Profile</strong> menu' => 'Menu <strong>Trang cá nhân</strong>',
    '<strong>Profile</strong> photo' => 'Hình ảnh <strong>Trang cá nhân</strong>',
    '<strong>Profile</strong> stream' => 'Dòng thời gian <strong>Trang cá nhân</strong>',
    '<strong>User profile</strong>' => '<strong>Trang hồ sơ người dùng</strong>',
