...
return array (
  'Base DN' => 'ベース識別名（DN）',
  'Defines the filter to apply, when login is attempted. %s replaces the username in the login action. Example: &quot;(sAMAccountName=%s)&quot; or &quot;(uid=%s)&quot;' => 'ログインが試行されたときに、適用するフィルターを定義します。%sはログインアクションのユーザー名を置き換えます。 例：(samaccountname=%s) または (uid=%s)',
