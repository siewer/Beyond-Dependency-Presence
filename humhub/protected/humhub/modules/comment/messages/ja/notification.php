...
return array (
  'Comments' => 'コメント',
  'Receive Notifications when someone comments on my own or a following post.' => '誰かがあなたやフォロワーの投稿にコメントしたとき通知を受け取る',
  'View Online' => 'オンラインで見る',
  '[Deleted]' => '[削除済]',
  '{displayNames} commented {contentTitle}' => '{displayNames} が {contentTitle}をコメントしました',
  '{displayNames} commented {contentTitle} in space {space}' => '{displayNames}が  {space}で {contentTitle} コメントしました',
  '{displayNames} commented {contentTitle}.' => '{displayNames} が {contentTitle}をコメントしました。',
  '{displayNames} just commented your {contentTitle}' => '{displayNames} が今，あなたの {contentTitle}にコメントしました',
