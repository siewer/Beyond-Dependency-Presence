...
return [
    ...
    '<strong>Scheduled jobs</strong>' => '<strong>Ütemezett munkák</strong>',
    ...
    'Add following the lines to the crontab:' => 'Adja hozzá a következő sorokat a crontabhoz:',
    ...
    'HumHub uses cron jobs to execute scheduled or to run potentially heavy tasks such as sending out email summaries and notifications or optimizing the search index.' => 'A HumHub cron jobokat használ ütemezett vagy potenciálisan nehéz feladatok végrehajtására, például e-mail-összefoglalók és értesítések küldésére vagy a keresési index optimalizálására.',
    ...
    'Open the crontab of HumHub/PHP process user e.g. <code>{user}</code>.' => 'Nyissa meg a HumHub/PHP folyamatfelhasználó crontabját, pl. <code>{user}</code>.',
    ...
    'Registered members can invite new users via link' => 'A regisztrált tagok a linken keresztül hívhatnak meg új felhasználókat',
    ...
    'This topic is covered in more detail in our <a href="{link}" target="_blank">documentation</a>. If you have trouble setting up the job scheduling described in the documentation, please contact your server administrator for support.' => 'Ezzel a témával részletesebben a <a href="{link}">dokumentációnk</a> foglalkozik. Ha problémába ütközik a dokumentációban leírt munkaütemezés beállításakor, kérjük, forduljon a kiszolgáló rendszergazdájához támogatásért.',
