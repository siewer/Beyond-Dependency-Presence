...
return [
    ...
    'Language and timezone are automatically set according to the user\'s browser settings. If that is not possible, the default settings are used.' => 'El idioma y la zona horaria se determinan automáticamente de acuerdo a la configuración del navegador del usuario. Si esto no es posible, se utilizan los valores por defecto.',
