...
return [
    ...
    '<strong>Pretty URLs</strong>' => '<strong>Czytelne URL</strong>',
    ...
    'For more information on this topic, please refer to our <a href="{link}" target="_blank">documentation</a>.' => 'Więcej informacji uzyskasz w <a href="{link}" target="_blank">dokumentacji</a>.',
