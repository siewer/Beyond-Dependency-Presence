...
return [
  ...
  '<strong>Apache</strong> web server detected.' => 'Serveur web Apache détecté.',
  ...
  '<strong>Nginx</strong> web server detected.' => 'Serveur web Nginx détecté.',
  '<strong>Pretty URLs</strong>' => '<strong>Pretty URLs</strong>',
  ...
  'Ensure the following rule is present in your configuration: <strong>try_files $uri $uri/ /index.php?$args;</strong>.' => 'Assurez-vous que la règle suivante est présente dans votre configuration : <strong>try_files $uri $uri/ /index.php?$args;</strong>.',
  ...
  'For more information on this topic, please refer to our <a href="{link}" target="_blank">documentation</a>.' => 'Pour plus d’informations à ce sujet, veuillez consulter notre <a href="{link}" target="_blank">documentation</a>.',
  ...
  'In the installation folder, locate the <strong>.env.example</strong> file and copy its contents into the <strong>.env</strong> file. Next, find the <strong>Pretty URLs</strong> block and uncomment it by removing the <strong>#</strong> symbol.' => 'Dans le dossier d’installation, localisez le fichier <strong>.env.example</strong> et copiez son contenu dans le fichier <strong>.env</strong>. Ensuite, trouvez le bloc <strong>Pretty URLs</strong> et décommentez-le en supprimant le symbole <strong>#</strong>.',
  ...
  'Make sure that the following file is writable: thi' => 'Assurez-vous que le fichier suivant est accessible en écriture : thi',
  'My club' => 'Mon club',
  ...
  'Port' => 'Port',
  'Pretty URLs may not work correctly.' => 'Les réécriture d\'URLs peuvent ne pas fonctionner correctement.',
  'Pretty URLs should work correctly.' => 'Les réécriture d\'URLs devraient fonctionner correctement.',
  ...
  'The <strong>.htaccess</strong> file is in place.' => 'Le fichier <strong>.htaccess</strong> est en place.',
  'The <strong>.htaccess</strong> file is not in place. In the installation folder, locate the <strong>.htaccess.dist</strong> file and rename it to <strong>.htaccess</strong>.' => 'Le fichier <strong>.htaccess</strong> est introuvable. Dans le dossier d\'installation, localisez le fichier <strong>.htaccess.dist</strong> et renommez-le en <strong>.htaccess</strong>.',
  'The <strong>mod_rewrite</strong> module is active.' => 'Le module <strong>mod_rewrite</strong> est activé.',
  'The <strong>mod_rewrite</strong> module is not enabled.' => 'Le module <strong>mod_rewrite</strong> n\'est pas activé.',
  ...
  'Unable to automatically detect your web server type. Please ensure URL rewriting is configured.' => 'Impossible de détecter automatiquement le type de votre serveur web. Veuillez vérifier que la réécriture d\'URL est configurée.',
