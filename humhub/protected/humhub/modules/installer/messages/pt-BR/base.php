...
return [
    ...
    '<strong>Pretty URLs</strong>' => '<strong>URLs bonitas</strong>',
    '<strong>Scheduled jobs</strong>' => '<strong>Trabalhos agendados</strong>',
    ...
    'Add following the lines to the crontab:' => 'Adicione as seguintes linhas ao crontab:',
    ...
    'HumHub uses cron jobs to execute scheduled or to run potentially heavy tasks such as sending out email summaries and notifications or optimizing the search index.' => 'O HumHub usa tarefas cron para executar tarefas agendadas ou potencialmente pesadas, como enviar resumos e notificações por e-mail ou otimizar o índice de pesquisa.',
    'I want to use HumHub for:' => 'Quero usar o HumHub para:',
    'In the installation folder, locate the <strong>.env.example</strong> file and copy its contents into the <strong>.env</strong> file. Next, find the <strong>Pretty URLs</strong> block and uncomment it by removing the <strong>#</strong> symbol.' => 'Na pasta de instalação, localize o arquivo <strong>.env.example</strong> e copie seu conteúdo para o arquivo <strong>.env</strong>. Em seguida, encontre o bloco <strong>Pretty URLs</strong> e descomente-o removendo o símbolo <strong>#</strong>.',
    'Initializing database...' => 'Preparando o banco de dados...',
    'Installation Example:' => 'Exemplo de instalação:',
    'Language and timezone are automatically set according to the user\'s browser settings. If that is not possible, the default settings are used.' => 'O idioma e o fuso horário são definidos automaticamente de acordo com as configurações do navegador do usuário. Se isso não for possível, as configurações padrão são usadas.',
    'Localisation' => 'Localização',
    'Make sure that the following file is writable: thi' => 'Certifique-se de que o seguinte arquivo seja gravável: thi',
    'My club' => 'Meu clube',
    ...
    'Open the crontab of HumHub/PHP process user e.g. <code>{user}</code>.' => 'Abra o crontab do usuário do processo HumHub/PHP, por exemplo, <code>{user}</code>.',
    'Optional: Port of your MySQL Database Server. Leave empty to use default port.' => 'Opcional: porta do seu servidor de banco de dados MySQL. Deixe em branco para usar a porta padrão.',
    'Password' => 'Senha',
    'Port' => 'Porta',
    ...
    'Registered members can invite new users via link' => 'Os membros registrados podem convidar novos usuários por meio de link',
    ...
    'This topic is covered in more detail in our <a href="{link}" target="_blank">documentation</a>. If you have trouble setting up the job scheduling described in the documentation, please contact your server administrator for support.' => 'Este tópico é abordado com mais detalhes em nossa <a href="{link}" target="_blank">documentação</a>. Se você tiver problemas para configurar o agendamento de tarefas descrito na documentação, entre em contato com o administrador do servidor para obter suporte.',
    ...
    'The <strong>.htaccess</strong> file is not in place. In the installation folder, locate the <strong>.htaccess.dist</strong> file and rename it to <strong>.htaccess</strong>.' => '',
    'The <strong>mod_rewrite</strong> module is active.' => '',
    'The <strong>mod_rewrite</strong> module is not enabled.' => '',
    'Unable to automatically detect your web server type. Please ensure URL rewriting is configured.' => '',
];
