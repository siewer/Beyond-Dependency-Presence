...
## Enhanced audit logging :ak-enterprise {#enhanced-audit-logging}
...
## Viewing events in maps and charts :ak-enterprise {#viewing-events-in-maps-and-charts}
...
## Export events :ak-enterprise {#export-events}
...
2. Set a [search query](#advanced-queries) as well as the ordering, as needed. The data export will honor these settings.
