...
- **WebFinger support**
    ...
    With the addition of the [default application](../../sys-mgmt/brands/index.md#external-user-settings) setting, when the default application uses an OIDC provider, a WebFinger endpoint is available now.
