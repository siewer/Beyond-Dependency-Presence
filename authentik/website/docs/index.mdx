...
We offer two versions of authentik: the forever-free open source project upon which everything is built, and our source available Enterprise version, with a Support center and additional features.
...
- For developer-focused documentation, such as using our APIs and blueprints, setting up your development environment, translations, or how to contribute, refer to the [**Developer**](./developer-docs/index.mdx) area, accessible from the top menu bar.
